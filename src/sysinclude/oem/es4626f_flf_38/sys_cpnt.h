...
#define SYS_CPNT_COS_CONTAIN_CLI_MAP_IP_PRECEDENCE              (TRUE  && !SYS_CPNT_COS_INTER_DSCP)
#define SYS_CPNT_COS_CONTAIN_CLI_MAP_IP_DSCP                    (TRUE  && !SYS_CPNT_COS_INTER_DSCP)
#define SYS_CPNT_COS_CONTAIN_CLI_MAP_IP_PORT                    (TRUE  && !SYS_CPNT_COS_INTER_DSCP)
#define SYS_CPNT_COS_CONTAIN_CLI_MAP_ACCESS_LIST                (FALSE && !SYS_CPNT_COS_INTER_DSCP)
#define SYS_CPNT_COS_MAP_COS2QUEUE                              (FALSE && !SYS_CPNT_COS_INTER_DSCP)
...
#define SYS_CPNT_DAI_RATE_LIMIT_BY_RULE     TRUE
