...
#define SYS_HWCFG_DRAM_SIZE                         (128 * SYS_TYPE_1M_BYTES) /* Need to change to 128 later, thomas */
...
#define SYS_HWCFG_CPLD_BASE                 SYS_HWCFG_RCS1_BASE
 ...
 */
#define SYS_HWCFG_WATCH_DOG_CONTROL_ADDRESS         (SYS_HWCFG_CPLD_BASE + 0x02) /* 0xE0100002 */
 ...
 * ----------------------------------------------------------------------------------------
 ...
 STACK_LINK_G, STACK_LINK_A:
        ...
        11: Off
 */
#define SYS_HWCFG_SYSTEM_LED_0_ADDR                 (SYS_HWCFG_CPLD_BASE + 0x07) /*0xE0100007*/
...
#define SYS_HWCFG_SYSTEM_PWR_LED_GREEN              0x20
#define SYS_HWCFG_SYSTEM_PWR_LED_AMBER              0x10
...
#define SYS_HWCFG_SYSTEM_RPU_LED_GREEN              0x80
#define SYS_HWCFG_SYSTEM_RPU_LED_AMBER              0x40
...
#define SYS_HWCFG_SYSTEM_STACK_LINK_OK              0x02
#define SYS_HWCFG_SYSTEM_STACK_LINK_DOWN_OR_NOSTACK 0x01
#define SYS_HWCFG_SYSTEM_STACK_LINK_OFF             0x03

/* System LED 1 (Read/Write, 0xE0100008)
 * -----------------------------------------------------------------------------------
 * |         7       |        6       |        5            |         4         |        3        |        2        |       1         |       0         |
 * |---------|--------|-----------|-----------|--------------------------------------|
 ...
 * ----------------------------------------------------------------------------------------
 DIAG_G, DIAG_A:
        00: Off
        10: Green light, System Diagnostic test OK
        01: Amber light, System Diagnostic test failed
        11: Off
 STCK_MST, STCK_SLV:
        00: Off
        10: Green light, Stack operation State(Master UNIT)
        01: Amber light, Stack operation State(Slave UNIT)
        11: Off, Other units in the stacking chain during stack ready
 */
#define SYS_HWCFG_SYSTEM_LED_1_ADDR                 (SYS_HWCFG_CPLD_BASE + 0x08) /*0xE0100008*/
...
/* PoE LED */
#define SYS_HWCFG_SYSTEM_POE_LED_ADDR              SYS_HWCFG_SYSTEM_LED_1_ADDR
#define SYS_HWCFG_SYSTEM_POE_LED_MASK              0x03
#define SYS_HWCFG_SYSTEM_POE_SHIFT                 0
#define SYS_HWCFG_SYSTEM_POE_OPERATION             0x01
#define SYS_HWCFG_SYSTEM_POE_OFF                   0x03

/*7 segment LED  (Read/Write, 0xE0100009)
*/
#define SYS_HWCFG_7_SEGMENT_LED_ADDR                (SYS_HWCFG_CPLD_BASE + 0x09) /*0xE0100009*/
...
#define SYS_HWCFG_FAN_CONTROLLER_TYPE      SYS_HWCFG_FAN_NONE
 ...
 */
#define SYS_HWCFG_GBIC_AB_MINIGBIC_CONTROL_ADDR         (SYS_HWCFG_CPLD_BASE + 0x0E) /*0xE010000E*/
#define SYS_HWCFG_GBIC_A_TX_DISABLE                     0x08
#define SYS_HWCFG_GBIC_B_TX_DISABLE                     0x80

/* GBIC/MINIGBIC Tx Disable and SCL Select Setting at module C and D (Read/Write)
 */
#define SYS_HWCFG_GBIC_CD_MINIGBIC_CONTROL_ADDR         (SYS_HWCFG_CPLD_BASE + 0x0C) /*0xE010000C*/
#define SYS_HWCFG_GBIC_C_TX_DISABLE                     0x08
#define SYS_HWCFG_GBIC_D_TX_DISABLE                     0x80
 ...
 */
#define SYS_HWCFG_COMBO_PORT1_SFP_STATUS_ADDR           SYS_HWCFG_GBIC_STATUS_1_ADDR
#define SYS_HWCFG_COMBO_PORT1_SFP_MODULE_PRESENT_MASK   0x02

/* Define the EPLD address for GBIC B
 */
#define SYS_HWCFG_COMBO_PORT2_SFP_STATUS_ADDR           SYS_HWCFG_GBIC_STATUS_1_ADDR
#define SYS_HWCFG_COMBO_PORT2_SFP_MODULE_PRESENT_MASK   0x20

/* Define the EPLD address for GBIC C
 */
#define SYS_HWCFG_COMBO_PORT3_SFP_STATUS_ADDR           SYS_HWCFG_GBIC_STATUS_0_ADDR
#define SYS_HWCFG_COMBO_PORT3_SFP_MODULE_PRESENT_MASK   0x02

/* Define the EPLD address for GBIC D
 */
#define SYS_HWCFG_COMBO_PORT4_SFP_STATUS_ADDR           SYS_HWCFG_GBIC_STATUS_0_ADDR
#define SYS_HWCFG_COMBO_PORT4_SFP_MODULE_PRESENT_MASK   0x20

#define SYS_HWCFG_MAX_NBR_OF_I2C_CHANNEL       4
...
/* EPLD Version (Read Only, 0xE010000F)
  ...
  * ----------------------------------------------------------------------------
  ...
  VER ID:Version Description
        ...
        100 R01
  */
#define SYS_HWCFG_EPLD_VERSION_ADDR                 (SYS_HWCFG_CPLD_BASE + 0x0F) /*0xE010000F*/
...
#define SYS_HWCFG_MAX_NBR_OF_THERMAL_PER_UNIT       0

#define SYS_HWCFG_MAX_NBR_OF_FAN_PER_UNIT               0
...
#define SYS_HWCFG_GPIO_OUT      0xF1010140
#define SYS_HWCFG_GPIO_IN       0xF1010150
#define SYS_HWCFG_GPIO_ACT      0xF1010144

/* PoE controller reset bits
 */
#define SYS_HWCFG_SYSTEM_RESET_POE_SOFTWARE_RESET   0x01
#define SYS_HWCFG_SYSTEM_RESET_POE_ENABLE           0x40

/* For PoE Power Allocation
*/
#define SYS_HWCFG_MAX_POWER_ALLOCATION_RPS          195
#define SYS_HWCFG_MAX_POWER_ALLOCATION_LOCAL        195
#define SYS_HWCFG_MIN_POWER_ALLOCATION              37
#define SYS_HWCFG_MAX_POWER_INLINE_ALLOCATION       30000
#define SYS_HWCFG_MIN_POWER_INLINE_ALLOCATION       3000
 ...
 */
#define SYS_HWCFG_MAX_NBR_OF_PCL_PER_CHIP                   1024 /* 10 bits */
#define SYS_HWCFG_MAX_NBR_OF_PCE_PER_CHIP                   (640 + 512)  /* CPSS_MAX_NUM_RULE also should modified */

//#define SYS_HWCFG_MAX_METER_ENTRY_NUM                       64
//#define SYS_HWCFG_MAX_NBR_OF_EGRESS_METER_PER_CHIP          64
// BobCat
#define SYS_HWCFG_MAX_METER_ENTRY_NUM                       300
#define SYS_HWCFG_MAX_NBR_OF_EGRESS_METER_PER_CHIP          300
