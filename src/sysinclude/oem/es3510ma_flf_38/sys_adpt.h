 ...
 */
#define SYS_ADPT_EXTRA_TASK_STACK_SIZE      (16 * SYS_TYPE_1K_BYTES)
 ...
 */
#define SYS_ADPT_MAX_NBR_OF_UNIT_PER_STACK                      2   /* Max number of units can be stacked togather   */
#define SYS_ADPT_MAX_NBR_OF_DRIVER_UNIT_PER_STACK               2   /* Max number of driver units */
#define SYS_ADPT_MAX_NBR_OF_PORT_PER_UNIT                       12  /* Max number of port can be installed in a unit */
 ...
 */
#define SYS_ADPT_MAX_NBR_OF_PORT_PER_UNIT_ON_BOARD              12  /* Max number of port can be installed in a unit */
...
#define SYS_ADPT_TOTAL_PORTS_PER_UNIT_ON_BOARD                  12

/* Define switch clustering parameters
 */
#define SYS_ADPT_CLUSTER_MAX_NBR_OF_MEMBERS                     36  /* limitation of cluster members */
...
#define SYS_ADPT_MAX_NBR_OF_CHIP_PER_UNIT                       SYS_ADPT_MAX_NBR_OF_DRIVER_UNIT_PER_STACK
#define SYS_ADPT_MAX_NBR_OF_SWITCH_PORT_PER_CHIP                (SYS_ADPT_MAX_NBR_OF_PORT_PER_UNIT/SYS_ADPT_MAX_NBR_OF_CHIP_PER_UNIT)


#define SYS_ADPT_NBR_OF_BUILD_IN_COMBO_PORT_PER_UNIT            2   /* Number of build-in combo ports in a unit */
 ...
 */
#define SYS_ADPT_MAX_NBR_OF_L2_MAC_ADDR_ENTRY           (8 * SYS_TYPE_1K)
 ...
 */
#define SYS_ADPT_MAX_NBR_OF_TRUNK_PER_SYSTEM             5  /* Max number of trunk port can be setup per stack , ES3510MA is 8+2 SWITCH, We use 10/2*/
...
#define SYS_ADPT_MAX_NBR_OF_10GIGA_PORT_PER_TRUNK        0
 ...
 */
#define SYS_ADPT_MAX_NBR_OF_PRIORITY_QUEUE               4
...
#define SYS_ADPT_MAX_VLAN_NAME_LEN                       128      /* 32 chars */
 ...
 */
#define SYS_ADPT_1V_MAX_PROTOCOL_VALUE_BUFFER_LENGTH            2

#define SYS_ADPT_1V_MAX_NBR_OF_FRAME_TYPE                       3       /* chip limitation */
#define SYS_ADPT_1V_MAX_NBR_OF_PROTOCOL_GROUP                   12      /* chip limitation */
 ...
 */
#define SYS_ADPT_1V_MAX_NBR_OF_PROTOCOL_PORT_ENTRY_PER_PORT	    12
...
#define SYS_ADPT_IGMP_MAX_SUPPORT_GROUP                         255 /*can't be large than SYS_ADPT_MAX_MULTICAST_FORWARDING_ENTRY*/
...
#define SYS_ADPT_IGMP_SNOOPING_ENTRY_LIMIT_MAX                  255 /*can't be large than SYS_ADPT_MAX_MULTICAST_FORWARDING_ENTRY*/
#define SYS_ADPT_IGMP_SNOOPING_ENTRY_LIMIT_HALF_MAX             255 /*can't be large than SYS_ADPT_MAX_MULTICAST_FORWARDING_ENTRY*/
...
#define SYS_ADPT_MLDSNP_MAX_NBR_OF_GROUP_ENTRY                  255   /* unknown + static + dynamic */
#define SYS_ADPT_MLDSNP_MAX_NBR_OF_ROUTER_PORT                  32   /* max route port -- by vlan */
#define SYS_ADPT_MDSLNP_MAX_NBR_OF_STATIC_GROUP                 64
...
/*
   2010/3/4, enlarge 255 to 1024 which large than SYS_ADPT_MAX_MULTICAST_FORWARDING_ENTRY
   After Macauley verified, it's OK.
*/
#define SYS_ADPT_MVR_MAX_NBR_OF_GROUPS                          1024 /*can't be large than SYS_ADPT_MAX_MULTICAST_FORWARDING_ENTRY*/
#define SYS_ADPT_MVR_MAX_FORWARD_PRIORITY                       6   /*depend on chip*/
#define SYS_ADPT_MVR_MIN_FORWARD_PRIORITY                       0   /*depend on chip*/

#define SYS_ADPT_MVR_MAX_NBR_OF_RECEIVER_GROUPS                 5
 ...
 */
#define SYS_ADPT_MAX_NBR_OF_MIRROR_PORT                         6
...
#define SYS_ADPT_MAX_CONFIG_FILE_SIZE                           (1024*100)
...
#define SYS_ADPT_QOS_MIN_POLICE_BURST (  4  * SYS_TYPE_1K_BYTES)
#define SYS_ADPT_QOS_MAX_POLICE_BURST (512  * SYS_TYPE_1K_BYTES) /* 512 K */
#define SYS_ADPT_QOS_MIN_POLICE_RATE  64 /* kbps */
#define SYS_ADPT_QOS_MAX_POLICE_RATE  (1  * 1000 * 1000) /* kbps */ /* 1  GBPS for mini-GBIC */

#define SYS_ADPT_ACL_MAX_DST_IPV6_PREFIX_LEN    8

#define SYS_ADPT_DIFFSERV_MIN_POLICE_BURST  (4  * 1000) /* 4k bytes    */
#define SYS_ADPT_DIFFSERV_MAX_POLICE_BURST  (16  * 1000 * 1000) /* 16m bytes */

#define SYS_ADPT_DIFFSERV_MIN_POLICE_RATE   (             64) /* kbps         */
 ...
 */
#define SYS_ADPT_PRIVATEMIB_OID                             1, 3, 6, 1, 4, 1, 259, 8, 1, 11
...
*/
#define SYS_ADPT_HTTP_WEB_INDEX_PAGE_PATH       "/index_309.htm"
...
#define SYS_ADPT_NETACCESS_MAX_NBR_OF_SECURE_ADDRESSES_PER_PORT        2048 /* 1024 */
 ...
 *
 *       for AlleyCat, when configure MRU to 10240,
 *       whether received packet is untagged or tagged,
 *       the size of egress packet is 10240 at most.
 */
#if (SYS_CPNT_SWCTRL_MTU_CONFIG_MODE == SYS_CPNT_SWCTRL_MTU_NOT_CONFIGURABLE)
#define SYS_ADPT_MAX_JUMBO_MTU                          10240
#else
...
#ifndef ES3526MA_POE_7LF_LN /*add to avoid compile warning */
#define ES3526MA_POE_7LF_LN
#endif

#ifndef ES3510MA_FLF_38
#define ES3510MA_FLF_38
#endif
 ...
 */
#define SYS_ADPT_SYS_DESC_STR_FOR_BOARD_ID0     "ES3510MA"
#define SYS_ADPT_SYS_DESC_STR_FOR_BOARD_ID1     ""
 ...
 * Board ID dependence is for some customers who have different sysOID's.
 */
#define SYS_ADPT_SYS_OID_STR_FOR_BOARD_ID0      "1.3.6.1.4.1.259.8.1.11"
#define SYS_ADPT_SYS_OID_STR_FOR_BOARD_ID1      "0.0"
 ...
 */
#define SYS_ADPT_DOT1Q_TUNNEL_TPID_MIN 0x800
 ...
 * Board ID dependence is for some customers who have different sysOID's.
 */
#define SYS_ADPT_PRIVATE_MIB_ROOT_FOR_BOARD_ID0         "1.3.6.1.4.1.259.8.1.11"
#define SYS_ADPT_PRIVATE_MIB_ROOT_FOR_BOARD_ID1         ""
 ...
 * Board ID dependence is for some customers who have different sysOID's.
 */
#define SYS_ADPT_PRODUCT_NAME_FOR_BOARD_ID0             "ES3510MA"
#define SYS_ADPT_PRODUCT_NAME_FOR_BOARD_ID1             ""
...
#define SYS_ADPT_MODEL_NAME_FOR_BOARD_ID0             "ES3510MA"
#define SYS_ADPT_MODEL_NAME_FOR_BOARD_ID1             ""
 ...
 */
#define SYS_ADPT_PRODUCT_MANUFACTURER                   "Edge-Core"
#define SYS_ADPT_PRODUCT_DESCRIPTION                    "http://www.edge-core.com"
#define SYS_ADPT_PRODUCT_CLASS                          "8 10/100 ports + 2 ComboG L2/L4 standalone switch"
 ...
 */
#define SYS_ADPT_MAX_DOT1D_TP_AGING_TIME                844
...
#define SYS_ADPT_MAX_LAN_RX_BUF_SIZE_PER_PACKET         1538 /* Refer to RX_BUFF_SIZE_DEF defined in Marvell CPSS gtAppDemoSysConfigDefaults.h */
#define SYS_ADPT_RX_BUFF_ALIGN                          1    /* For rx buffer address aligned */
#define SYS_ADPT_MAX_NBR_OF_LAN_PACKET_RX_BUFFER          512
#define SYS_ADPT_MAX_NBR_OF_LAN_PACKET_TX_BUFFER       (SYS_ADPT_L_IPCMEM_NUMBER_OF_BUF_64  + \
...
#define SYS_ADPT_MAX_NBR_OF_AU_DESC                     256 /* For address update(AU) descriptor in MARVELL */
...
#define SYS_ADPT_NIC_NBR_OF_PACKET_BUFFER_PER_PRIORITY      30   /* queue size per prioity queue for front port packet */
#define SYS_ADPT_NIC_NBR_OF_PACKET_BUFFER_FOR_ISC           120    /* queue size of prioity queue for ISC packet except STKTPLG */
#define SYS_ADPT_NIC_NBR_OF_PACKET_BUFFER_FOR_ISC_REPLY     120    /* message queue size reserved for ISC reply packet */
#define SYS_ADPT_NIC_NBR_OF_PACKET_BUFFER_FOR_ISC_STKTPLG   30 /* reserved for ISC stktplg packet */
#define SYS_ADPT_NIC_NBR_OF_PACKET_BUFFER_FOR_1_ASIC_DMA    10    /* reserve buffer number per ASIC chip */
...
#define SYS_ADPT_MAX_NBR_OF_MST_INSTANCE                32     /* 31(MSTIs) + 1(CIST), Max is 32 */
#define SYS_ADPT_XSTP_REGION_NAME                       "XSTP REGION 0"

#define SYS_ADPT_MAX_BSTORM_RATE_LIMIT                  1000000 /* unit Kbps */
#define SYS_ADPT_MIN_BSTORM_RATE_LIMIT                  64

#define SYS_ADPT_MAX_MSTORM_RATE_LIMIT                  1000000 /* unit Kbps */
#define SYS_ADPT_MIN_MSTORM_RATE_LIMIT                  64

#define SYS_ADPT_MAX_UNKNOWN_USTORM_RATE_LIMIT          1000000 /* unit Kbps */
#define SYS_ADPT_MIN_UNKNOWN_USTORM_RATE_LIMIT          64
...
#define SYS_ADPT_BPDU_FLOOD_ON_STP_DISABLED            FALSE

/* The SYS_ADPT_MAX_RATE_LIMIT value is different in different project
 * 5508 is 10000, blanc/blanc-08/Hagrid is 1000, unit is Mbps
 * ES3550MO is 64 ~ 1000000 Kbps, interval is 64Kbps
 */
#define SYS_ADPT_MAX_RATE_LIMIT                 1000000
#define SYS_ADPT_MIN_RATE_LIMIT                 64

#define SYS_ADPT_PACKETCELL_INTERVAL            64
...
#define SYS_ADPT_CPU_PORT_PPS                  1000
#define SYS_ADPT_CPU_PORT_BURST                 500

#define SYS_ADPT_CPU_COS0_PPS                  800
#define SYS_ADPT_CPU_COS0_BURST                400
#define SYS_ADPT_CPU_COS1_PPS                  800
#define SYS_ADPT_CPU_COS1_BURST                400
#define SYS_ADPT_CPU_COS2_PPS                  800
#define SYS_ADPT_CPU_COS2_BURST                400
#define SYS_ADPT_CPU_COS3_PPS                  800
#define SYS_ADPT_CPU_COS3_BURST                400
#define SYS_ADPT_CPU_COS4_PPS                  800
#define SYS_ADPT_CPU_COS4_BURST                400
#define SYS_ADPT_CPU_COS5_PPS                  800
#define SYS_ADPT_CPU_COS5_BURST                400
#define SYS_ADPT_CPU_COS6_PPS                  800
#define SYS_ADPT_CPU_COS6_BURST                400
#define SYS_ADPT_CPU_COS7_PPS                  800
...
#define SYS_ADPT_ALLOCATE_RX_FROM_IPCMEM    FALSE/* anzhen.zheng, 2009-05-13, 18:34:50 */
...
#define SYS_ADPT_GE_LWM_COS_CELL_LIMIT_0    28
#define SYS_ADPT_GE_LWM_COS_CELL_LIMIT_1    44
#define SYS_ADPT_GE_LWM_COS_CELL_LIMIT_2    68
#define SYS_ADPT_GE_LWM_COS_CELL_LIMIT_3    84
#define SYS_ADPT_GE_LWM_COS_CELL_LIMIT_4    96
#define SYS_ADPT_GE_LWM_COS_CELL_LIMIT_5    112
#define SYS_ADPT_GE_LWM_COS_CELL_LIMIT_6    124
#define SYS_ADPT_GE_LWM_COS_CELL_LIMIT_7    148
#define SYS_ADPT_GE_DYN_CELL_LIMIT          2208
#define SYS_ADPT_GE_HOL_COS_PKT_LIMIT       192
#define SYS_ADPT_GE_IBP_CELL_LIMIT          716
#define SYS_ADPT_GE_IBP_PKT_LIMIT           40

#define SYS_ADPT_HG_LWM_COS_CELL_LIMIT_0    28
#define SYS_ADPT_HG_LWM_COS_CELL_LIMIT_1    44
#define SYS_ADPT_HG_LWM_COS_CELL_LIMIT_2    68
#define SYS_ADPT_HG_LWM_COS_CELL_LIMIT_3    84
#define SYS_ADPT_HG_LWM_COS_CELL_LIMIT_4    96
#define SYS_ADPT_HG_LWM_COS_CELL_LIMIT_5    112
#define SYS_ADPT_HG_LWM_COS_CELL_LIMIT_6    124
#define SYS_ADPT_HG_LWM_COS_CELL_LIMIT_7    148
#define SYS_ADPT_HG_DYN_CELL_LIMIT          2208
#define SYS_ADPT_HG_HOL_COS_PKT_LIMIT       192
#define SYS_ADPT_HG_IBP_CELL_LIMIT          716
#define SYS_ADPT_HG_IBP_PKT_LIMIT           40

#define SYS_ADPT_CPU_LWM_COS_CELL_LIMIT     108
#define SYS_ADPT_CPU_DYN_CELL_LIMIT         0
#define SYS_ADPT_CPU_HOL_COS_PKT_LIMIT      37/* packet to CPU, CPU HOL happens before ingress port's IBP, avoid packet loss by ingress port's IBP. */
#define SYS_ADPT_CPU_IBP_CELL_LIMIT         8192/* tropicana has 8192 cells(2M bytes) packet buffer, CPU port should not entering IBP in any condition. */
#define SYS_ADPT_CPU_IBP_PKT_LIMIT          1536/* max XQ for FE and GE is 1536, CPU port should not entering IBP in any condition. */

#define SYS_ADPT_TOTAL_DYN_CELL_LIMIT       4096/* To pass through put test for different size packet, modify total dynamic cell to be half of total buffer(8192 cells). */
#define SYS_ADPT_IBP_DISCARD_LIMIT          8192
#endif
 ...
 * do for loop
 */
#define SYS_ADPT_COMBO_PORT_CAPABILITY_PER_UNIT         SYS_ADPT_NBR_OF_BUILD_IN_COMBO_PORT_PER_UNIT  /*it should be 24 in ECN430.*/

/* Definition for max number of power
 */
#define SYS_ADPT_MAX_NBR_OF_POWER_PER_UNIT              1 /*2*/
...
#define SYS_ADPT_MAX_NBRS_OF_ACL                        (64*SYS_ADPT_MAX_NBR_OF_UNIT_PER_STACK *2)
 ...
 *
 */
#define SYS_ADPT_MAX_NBRS_OF_ACE                        96//100 /*64*/ /* 32 */

/* User view, how many ACE in the system
 */
#define SYS_ADPT_MAX_NBRS_OF_ACE_OF_SYSTEM              513//512
 ...
 * chip.
 */
#define SYS_ADPT_MAX_NBRS_OF_MAC_ACE                    96
#define SYS_ADPT_MAX_NBRS_OF_IP_ACE                     96
#define SYS_ADPT_MAX_NBRS_OF_IPV6_ACE                   96
...
#define  SYS_ADPT_DIFFSERV_MAX_NBR_OF_CLASS             SYS_ADPT_MAX_NBRS_OF_ACE_OF_SYSTEM /* 128 */

/* CLASS MAP to RULE is 1 to many */
#define  SYS_ADPT_DIFFSERV_MAX_NBR_OF_CLASS_MAP         SYS_ADPT_MAX_NBRS_OF_ACE_OF_SYSTEM /* 32 */
...
#define  SYS_ADPT_DIFFSERV_MAX_NBR_OF_METER             SYS_ADPT_MAX_NBRS_OF_ACE_OF_SYSTEM /* 288 */
#define  SYS_ADPT_DIFFSERV_MAX_NBR_OF_ACTIONS           SYS_ADPT_MAX_NBRS_OF_ACE_OF_SYSTEM /* 288 */

#define SYS_ADPT_DIFFSERV_MAX_CLASS_NBR_OF_CLASS_MAP            16
#define SYS_ADPT_DIFFSERV_MAX_CLASS_MAP_NBR_OF_POLICY_MAP       200	/* 16 */

/* for software bundle rate control
 */
#define SYS_ADPT_DIFFSERV_MAX_CLASS_MAP_OF_BUNDLE_GROUP     8
#define SYS_ADPT_DIFFSERV_MAX_BUNDLE_GROUP_OF_POLICY_MAP    5

#define SYS_ADPT_DIFFSERV_MIN_CLASS_PRIORITY                0
#define SYS_ADPT_DIFFSERV_MAX_CLASS_PRIORITY                1000

/* for WRR range
 */
#define SYS_ADPT_MAX_RATIO_OF_WRR                       255
#define SYS_ADPT_MIN_RATIO_OF_WRR                       1

/* 2008-06-02, Jinfeng.Chen: for DRR range */
#define SYS_ADPT_MAX_RATIO_OF_DRR						255
 ...
 */
#define SYS_ADPT_MAX_VRRP_PRIORITY                        MAX_vrrpOperPriority
...
#define SYS_ADPT_MAX_NBR_OF_RIF                          32

/* Total host entry in chip is 4K, reserve 1K for multicast routing. */
#define SYS_ADPT_MAX_ARP_ENTRY                            (3 * SYS_TYPE_1K_BYTES )
 ...
 */
/* Total route entry in chip is 8K */
#define SYS_ADPT_MAX_NBR_OF_TOTAL_ROUTE_ENTRY               (8*SYS_TYPE_1K)
#define	SYS_ADPT_MAX_NBR_OF_STATIC_ROUTE_ENTRY				256
...
#define SYS_ADPT_MAX_MULTICAST_FORWARDING_ENTRY                 255
...
#define SYS_ADPT_MIN_PIM_STATE_REFRESH_INTERVAL     4   /* seconds, from cisco */
#define SYS_ADPT_MIN_PIM_REGISTER_RATE_LIMIT        1
#define SYS_ADPT_MIN_PIM_SWITCHOVER_THRESHOLD       0
#define SYS_ADPT_MIN_PIM_DESIGNATED_ROUTER_PRIORITY 0
#define SYS_ADPT_MIN_PIM_BSR_PRIORITY               0
#define SYS_ADPT_MIN_PIM_BSR_HASH_MASK_LEN          1
#define SYS_ADPT_MIN_PIM_RP_CANDIDATE_INTERVAL      60  /* refer from RFC5059, should not smaller than BS period*/
#define SYS_ADPT_MIN_PIM_RP_CANDIDATE_PRIORITY      0   /* from cisco */
...
#define SYS_ADPT_MAX_PIM_STATE_REFRESH_INTERVAL     100   /* seconds, from cisco */
#define SYS_ADPT_MAX_PIM_REGISTER_RATE_LIMIT        65535
#define SYS_ADPT_MAX_PIM_SWITCHOVER_THRESHOLD       4294967
#define SYS_ADPT_MAX_PIM_DESIGNATED_ROUTER_PRIORITY 4294967294
#define SYS_ADPT_MAX_PIM_BSR_PRIORITY               255
#define SYS_ADPT_MAX_PIM_BSR_HASH_MASK_LEN          32      /* ipv4 group address max length */
#define SYS_ADPT_MAX_PIM_RP_CANDIDATE_INTERVAL      16383   /* seconds, from cisco */
#define SYS_ADPT_MAX_PIM_RP_CANDIDATE_PRIORITY      0       /* from cisco */
...
#define SYS_ADPT_MAX_NBR_OF_NET_ROUTE               512  /* not used? */
...
*/
    ...
    #define SYS_ADPT_ARP_INSPECTION_MAX_NBR_OF_DENY_RULE                5
...
/* Yongxin.Zhao added for merge bcm-5.5.2, 2008.05.22 */
/* anzhen.zheng, 2009-05-13, 19:40:58 */
 ...
 */
#define SYS_ADPT_RESETMGMT_RESET_TO_FACTORY_DEFAULT_TIME  6 /*sec*/
#define SYS_ADPT_RESETMGMT_RESET_TIME                     3 /*sec*/

/* Yongxin.Zhao added for merge bcm-5.5.2, 2008.05.22 */
#if defined (SYS_CPNT_CFM) && (SYS_CPNT_CFM == TRUE)
#define SYS_ADPT_CFM_SUPPORTED_VERSION           0
#define SYS_ADPT_CFM_MAX_NBR_OF_MD                  8
#define SYS_ADPT_CFM_MAX_NBR_OF_MA                  8
#define SYS_ADPT_CFM_MAX_NBR_OF_MEP                 200
#define SYS_ADPT_CFM_MAX_NBR_OF_MIP                 200
...
#define SYS_CPNT_TWOCHIPSTACKINGINONEBOARD                                          FALSE
...
#define SYS_ADPT_UPLINK_STACKINGPORT                                                     2
#define SYS_ADPT_DOWNLINK_STACKINGPORT                                                   1
...
#define SYS_ADPT_DEV_UART_NAME_0                                                               "/dev/ttyS0"
#define SYS_ADPT_DEV_UART_NAME_1                                                               "/dev/ttyS1"
#define SYS_ADPT_RULE_CTRL_PORT_BITMAP_TO_CPU_ONLY                           0x00000001
#define SYS_ADPT_RULE_CTRL_PORT_BITMAP_TO_ALL_PORTS                          0x3fffffff
#define SYS_ADPT_RULE_CTRL_PORT_BITMAP_EXCLUDE_CPU                           0x3ffffffe
#define SYS_ADPT_RULE_CTRL_PHY_NUM_OF_CPU_PORT                               0x0

/* no used on Marvell chip */
#define SYS_ADPT_FP_SUPPORT_EFP_AND_VFP                     	FALSE
#define SYS_ADPT_FP_MAX_NBR_OF_GROUP_PER_CHIP                   16
#define SYS_ADPT_FP_MAX_NBR_OF_RULE_PER_SELECTOR                128


#define SYS_ADPT_PE_MAX_NBR_OF_RULE_FOR_L3_LITE_ROUTING                      (512)
...
/* Simon: just to pass compile */
#define SYS_ADPT_MAX_TUNNEL_ID 0

/* Yongxin.Zhao added, 2009-05-13, 16:40:31 */
#define SYS_ADPT_DMA_VIRTUAL_ADDR       0X50000000
 ...
 * file server.
 */
#define SYS_ADPT_XFER_AUTO_UPGRADE_OPCODE_SEARCH_FILENAME  "es3510ma.bix"

#if (SYS_CPNT_POE == TRUE)
#else
#define SYS_ADPT_MAX_NBR_OF_POE_PORT_PER_UNIT 1 /* define 1 in order to prevent illegal memory accessing in stktplg */
#endif
 ...
 */
#define SYS_ADPT_MAX_NBR_OF_QINQ_SERVICE_SUBSCRIPTION_PER_PORT      16
...
/* for G.8032 (ERPS)
 */
#define SYS_ADPT_ERPS_MAX_NBR_OF_DOMAIN         MAX_erpsDomainIndex
...
#if (SYS_CPNT_VLAN_XLATE == TRUE)
#define SYS_ADPT_MAX_NBR_OF_VLAN_XLATE_PER_PORT      8
#endif // SYS_CPNT_VLAN_XTLATE

#define SYS_ADPT_MAX_NBR_OF_PBR_RULE                 20
