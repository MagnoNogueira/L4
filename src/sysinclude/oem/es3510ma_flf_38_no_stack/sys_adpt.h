...
#define SYS_ADPT_MAX_NBR_OF_PORT_PER_UNIT                       10  /* Max number of port can be installed in a unit */
 ...
 */
#define SYS_ADPT_MAX_NBR_OF_PORT_PER_UNIT_ON_BOARD              10  /* Max number of port can be installed in a unit */
...
#define SYS_ADPT_TOTAL_PORTS_PER_UNIT_ON_BOARD                  10
...
#define SYS_ADPT_MAX_NBR_OF_CHIP_PER_UNIT                       2   /* Max number of chip can be installed in a unit */
#define SYS_ADPT_MAX_NBR_OF_SWITCH_PORT_PER_CHIP                5   /* Max number of switch port can be installed in a chip */
