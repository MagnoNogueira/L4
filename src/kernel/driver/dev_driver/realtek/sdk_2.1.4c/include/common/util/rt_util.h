 ...
 *
 * $Revision: 31362 $
 * $Date: 2012-07-24 21:18:31 +0800 (Tue, 24 Jul 2012) $
 *
...
#define RTK_SERDESMASK_SERDES_SET(serdesmask, serdes) \
do {\
    if ((serdes) <= RTK_MAX_SERDES_ID) {BITMAP_SET((serdesmask).bits, (serdes));}\
} while (0);\
