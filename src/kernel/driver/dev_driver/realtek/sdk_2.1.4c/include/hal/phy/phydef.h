...
#define PHY_MODEL_ID_RTL8214F           (0x14)
#define PHY_MODEL_ID_RTL8214            (0x14)
#define PHY_MODEL_ID_RTL8218_TC         (0x00) /* Test Chip */
#define PHY_MODEL_ID_RTL8218            (0x18)
#define PHY_MODEL_ID_RTL8201            (0x8201)
#define PHY_MODEL_ID_RTL8212F           (0x13)
#define PHY_MODEL_ID_RTL8208D_INT       (0x20) /* New PHY for RTL8328M internal */
...
#define PHY_MODEL_ID_RTL8218C_EXT       (0x18)
...
#define PHY_IDENT_RTL8214F  (PHY_MODEL_ID_RTL8214F << PHY_IDENT_MODEL_ID_OFFSET)|\
                            (PHY_REV_NO_A)

#define PHY_IDENT_RTL8214FB (PHY_MODEL_ID_RTL8214F << PHY_IDENT_MODEL_ID_OFFSET)|\
                            (PHY_REV_NO_B)

#define PHY_IDENT_RTL8214   (PHY_MODEL_ID_RTL8214 << PHY_IDENT_MODEL_ID_OFFSET)|\
                            (PHY_REV_NO_A)
...
#define PHY_IDENT_RTL8212F  (PHY_MODEL_ID_RTL8212F << PHY_IDENT_MODEL_ID_OFFSET)|\
                            (PHY_REV_NO_A)
...
typedef struct rt_phydrv_s
{
    ...
    int32   (*fPhydrv_slaveMaster_get)(uint32, rtk_port_t, rtk_port_masterSlave_t *, rtk_port_masterSlave_t *);
    int32   (*fPhydrv_slaveMaster_set)(uint32, rtk_port_t, rtk_port_masterSlave_t);
    int32   (*fPhydrv_fiberInternalLoopBackEnable_set)(uint32, rtk_port_t, rtk_enable_t);	
} rt_phydrv_t;
...
{
    uint32  phy_num;    /* PHY number in the chip, like 8218 is 8, 8214 is 4 */
