 ...
 */
extern int32 
dal_cypress_l2_legalPortMoveAction_set(uint32 unit, rtk_l2_lookupMissType_t port, rtk_action_t fwdAction);
...
#endif /* end of defined(CONFIG_SDK_DRIVER_RTK_BACKWARD_COMPATIBLE_8328) */
