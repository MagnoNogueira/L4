...
typedef enum drv_extGpio_accessMode_e
{
    ...
    EXT_GPIO_ACCESS_MODE_EXTRA,     /* extra-GPIO, applicable to 8380 */
...
extern int32 drv_extGpio_reg_read(uint32 unit, uint32 dev, uint32 reg, uint32 *pData);
extern int32 drv_extGpio_reg_write(uint32 unit, uint32 dev, uint32 reg, uint32 data);
