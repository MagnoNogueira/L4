 ...
 *            2) uart set & get
 */
#ifndef __UART_R8390_H__ 
#define __UART_R8390_H__
 ...
 */
extern int32
r8390_uart_init(uint32 unit,drv_uart_rxcallback_t rxcallback,drv_uart_txcallback_t txcallback);
 ...
 */
extern int32
r8390_uart_getc(uint32 unit, uint8 *pData);
 ...
 */
extern int32
r8390_uart_putc(uint32 unit, uint8 data);

/* Function Name:
 *      r8390_uart_baudrate_get
 * Description:
 ...
 */
extern int32
r8390_uart_baudrate_get(uint32 unit, drv_uart_baudrate_t *pBaudrate);

/* Function Name:
 *      r8390_uart_baudrate_set
 * Description:
 ...
 */
extern int32
r8390_uart_baudrate_set(uint32 unit, drv_uart_baudrate_t baudrate);

/* Function Name:
 *      r8390_serial_starttx
 * Description:
 ...
 */
extern void   
r8390_serial_starttx(uint32 unit);

/* Function Name:
 *      r8390_serial_clearfifo
 * Description:
 *      empty hw rx/tx fifo.
 * Input:
 *      unit  - unit id 
 ...
 */
extern void 
r8390_serial_clearfifo(uint32 unit);
#endif /* __UART_R8390_H__ */
