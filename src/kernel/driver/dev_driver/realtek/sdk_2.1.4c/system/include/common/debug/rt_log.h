 ...
 *
 * $Revision: 43824 $
 * $Date: 2013-10-25 09:22:29 +0800 (Fri, 25 Oct 2013) $
 *
...
#define MOD_PIE                 (1 << SDK_MOD_PIE)          /* 0x00040000 */
...
#define MOD_TIME                (1 << SDK_MOD_TIME)         /* 0x80000000 */
#define MOD_ACL                 ((uint64)1 << SDK_MOD_ACL)    /* 0x00000001-00000000 */
#define MOD_MPLS                ((uint64)1 << SDK_MOD_MPLS)   /* 0x00000002-00000000 */
#define MOD_DIAG                ((uint64)1 << SDK_MOD_DIAG)   /* 0x00000004-00000000 */
#define MOD_COMMON              ((uint64)1 << SDK_MOD_COMMON) /* 0x00000008-00000000 */
...
#define STR_MOD_PTP             "ptp"
#define STR_MOD_AVB             "avb"
#define STR_MOD_MPLS            "mpls"
...
#define RT_ERR(error_code, module, args...) \
     do { if(RT_ERR_OK != error_code)\
        if(RT_ERR_OK == rt_log(ERR_LEVEL_DEFAULT, module, ## args)) \
...
do {                                                \
    va_list va;                                     \
    va_start(va, format);                           \
    result = vsnprintf(buf, sizeof(buf)-1,          \
                       format, va);                 \
    va_end(va);                                     \
} while(0)
