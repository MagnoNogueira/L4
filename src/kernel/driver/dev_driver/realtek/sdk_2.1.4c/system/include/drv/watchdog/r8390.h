 ...
 *            2) scale set & get
 */
#ifndef __WATCHDOG_R8390_H__ 
#define __WATCHDOG_R8390_H__
 ...
 */
extern int32
r8390_watchdog_init(uint32 unit);

/* Function Name:
 *      r8390_watchdog_mode_set
 * Description:
 ...
 */
extern int32
r8390_watchdog_mode_set(uint32 unit, drv_watchdog_mode_t mode);

/* Function Name:
 *      r8390_watchdog_mode_get
 * Description:
 *      Get watchdog mode
 * Input:
 *      unit  - unit id
 ...
 */
extern int32
r8390_watchdog_mode_get(uint32 unit, drv_watchdog_mode_t *pMode);

/* Function Name:
 *      r8390_watchdog_scale_set
 * Description:
 ...
 */
extern int32 
r8390_watchdog_scale_set(uint32 unit, drv_watchdog_scale_t scale);

/* Function Name:
 *      r8390_watchdog_scale_get
 * Description:
 ...
 */
extern int32 
r8390_watchdog_scale_get(uint32 unit, drv_watchdog_scale_t *pScale);

/* Function Name:
 *      r8390_watchdog_enable_set
 * Description:
 ...
 */
extern int32 
r8390_watchdog_enable_set(uint32 unit, uint32 enable);

/* Function Name:
 *      r8390_watchdog_enable_get
 * Description:
 ...
 */
extern int32 
r8390_watchdog_enable_get(uint32 unit, uint32 *pEnable);
 ...
 */
extern int32 
r8390_watchdog_kick(uint32 unit);

/* Function Name:
 *      r8390_watchdog_threshold_set
 * Description:
 ...
 */
extern int32 
r8390_watchdog_threshold_set(uint32 unit, drv_watchdog_threshold_t *pThreshold);

/* Function Name:
 *      r8390_watchdog_threshold_get
 * Description:
 ...
 */
extern int32 
r8390_watchdog_threshold_get(uint32 unit, drv_watchdog_threshold_t *pThreshold);

#endif /* __WATCHDOG_R8390_H__ */
