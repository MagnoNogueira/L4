...
/*
 * L3 hardware insert and delete
 */

extern int soc_l3x_insert(int unit, l3x_entry_t *entry);
extern int soc_l3x_delete(int unit, l3x_entry_t *entry);
extern int soc_l3x_delete_all(int unit);
extern int soc_l3x_lookup(int unit, l3x_entry_t *key, l3x_entry_t *result,
			  int *index_ptr);
...
extern int soc_l3x_hash(int unit, int key_sip, l3x_entry_t *entry);
...
extern int soc_l3x_software_hash(int unit, int hash_select, int ipmc,
				 int key_sip, l3x_entry_t *entry);
