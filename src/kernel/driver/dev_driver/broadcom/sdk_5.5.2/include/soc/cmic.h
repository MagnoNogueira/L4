/*
 * $Id: cmic.h,v 1.29.2.3 Broadcom SDK $
...
/*
 * A/B scaler of core clock to generate 25 MHz frequency from core clock
 * (Lynx only).  Must set so CORE_CLOCK * Dividend / Divisor = 25MHz.
 */

#define CMIC_RATE_ADJUST                0x000001a0

#define CRA_DIVIDEND_SHFT               16
#define CRA_DIVIDEND_MASK               0xffff0000

#define CRA_DIVISOR_SHFT                0
#define CRA_DIVISOR_MASK                0x0000ffff
...
#define STAT_SYNC_TIMEOUT        (10  * SECOND_USEC)
...
/* Dump an S-Channel header and raw data words */
extern void soc_schan_dump(int unit, schan_msg_t *msg, int dwc);

/* Transact an S-Channel message to CMIC */
extern int soc_schan_op(int unit, schan_msg_t* msg,
                        int dwc_write, int dwc_read, int intr);
...
extern int soc_robo_anyreg_read(int unit, soc_regaddrinfo_t *ainfo, uint64 *data);
extern int soc_robo_anyreg_write(int unit, soc_regaddrinfo_t *ainfo, uint64 data);
...
extern int soc_robo_link_sw_update(int unit, int link, int port);
extern int soc_robo_wan_port_link_get(int unit, int *link);
extern int soc_robo_wan_port_link_sw_update(int unit, int link);
...
extern int soc_miim_write(int unit, uint8 phy_id,
...
extern int soc_robo_miim_write(int unit, uint32 phy_id,
                              uint32 phy_reg_addr, uint16 phy_wr_data);
extern int soc_robo_miim_int_write(int unit, uint32 phy_id,
                              uint32 phy_reg_addr, uint16 phy_wr_data);
extern int soc_sbx_miim_write(int unit, uint32 phy_id,
                              uint32 phy_reg_addr, uint16 phy_wr_data);

extern int soc_miim_read(int unit, uint8 phy_id,
...
extern int soc_robo_miim_read(int unit, uint32 phy_id,
                             uint32 phy_reg_addr, uint16 *phy_rd_data);
extern int soc_robo_miim_int_read(int unit, uint32 phy_id,
                             uint32 phy_reg_addr, uint16 *phy_rd_data);
extern int soc_sbx_miim_read(int unit, uint32 phy_id,
                             uint32 phy_reg_addr, uint16 *phy_rd_data);

extern int soc_miim_modify(int unit, uint8 phy_id,
                 uint16 phy_reg_addr, uint16 phy_rd_data, uint16 phy_rd_mask);

extern int soc_miimc45_write(int unit, uint8 phy_id, uint8 phy_devad,
           uint16 phy_reg_addr, uint16 phy_wr_data);
extern int soc_esw_miimc45_write(int unit, uint32 phy_id,
                              uint32 phy_reg_addr, uint16 phy_wr_data);
extern int soc_sbx_miimc45_write(int unit, uint32 phy_id,
                              uint32 phy_reg_addr, uint16 phy_wr_data);

extern int soc_miimc45_read(int unit, uint8 phy_id, uint8 phy_devad,
          uint16 phy_reg_addr, uint16 *phy_rd_data);
extern int soc_esw_miimc45_read(int unit, uint32 phy_id,
                             uint32 phy_reg_addr, uint16 *phy_rd_data);
extern int soc_sbx_miimc45_read(int unit, uint32 phy_id,
                                uint32 phy_reg_addr, uint16 *phy_rd_data);

extern int soc_miimc45_modify(int unit, uint8 phy_id, uint8 phy_devad,
                 uint16 phy_reg_addr, uint16 phy_rd_data, uint16 phy_rd_mask);
