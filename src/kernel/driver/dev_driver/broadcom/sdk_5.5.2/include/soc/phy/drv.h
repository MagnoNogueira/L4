...
/* Yongxin.Zhao added, for merge bcm-5.5.2, 2008-05-21, 19:21:17 */
...
typedef struct phy_driver_s {
	...
	int  (*pd_phy_ioctl)(int ,soc_port_t ,unsigned int,void * );
} phy_driver_t;
...
#define PHY_IOCTL(_pd, _u, _p, _cmd,_req) \
        _PHY_CALL((_pd), pd_phy_ioctl, ((_u), (_p), (_cmd),(_req)))
