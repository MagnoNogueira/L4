/*
 * $Id: macipadr.h,v 1.6 Broadcom SDK $
...
typedef uint8   ip6_addr_t[16];         /* IPv6 Address */

extern const mac_addr_t _soc_mac_spanning_tree;
extern const mac_addr_t _soc_mac_all_routers;
extern const mac_addr_t _soc_mac_all_zeroes;
extern const mac_addr_t _soc_mac_all_ones;
...
#define MAC_ADDR_EQUAL(m1, m2) (!sal_memcmp(m1, m2, sizeof(mac_addr_t)))

/* mac_addr_t m1, m2;  like memcmp, returns -1, 0, or 1 */
#define MAC_ADDR_CMP(m1, m2) sal_memcmp(m1, m2, sizeof(mac_addr_t))

/* mac_addr_t mac; True if multicast mac address */
