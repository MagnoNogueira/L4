/*
 * $Id: schanmsg.h,v 1.12 Broadcom SDK $
...
typedef struct schan_header_s {
    ...
    uint32 cpu:1,               /* Bit 0 NAK on XGS3 */
           cos:3,               /* Bits [2:1] L2/3 bank on some XGS3 */
           ecode: 2,
           ebit:1,
           datalen:7,
    ...
    uint32 opcode:6,            /* Bits 31:26 */
           ...
           ebit:1,
           ecode: 2,
           cos:3,               /* Bits [2:1] L2 bank on some XGS3 */
           cpu:1;               /* NAK on XGS3 */
#endif
} schan_header_t;
...
#define SCHAN_GEN_RESP_ERROR_BUSY        0
...
/* New for 5661x (see soc_feature_generic_table_ops) */
#define TABLE_INSERT_CMD_MSG          0x24      /* 5661x */
#define TABLE_INSERT_DONE_MSG         0x25      /* 5661x */
#define TABLE_DELETE_CMD_MSG          0x26      /* 5661x */
#define TABLE_DELETE_DONE_MSG         0x27      /* 5661x */
#define TABLE_LOOKUP_CMD_MSG          0x28      /* 5661x */
#define TABLE_LOOKUP_DONE_MSG         0x29      /* 5661x */
