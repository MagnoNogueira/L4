/*
 * $Id: easyrider.h,v 1.40 Broadcom SDK $
...
typedef uint32 soc_er_cd_chunk_t[SOC_ER_CELLDATA_CHUNKS][SOC_MAX_MEM_WORDS];
typedef uint32 soc_er_cd_slice_t[SOC_ER_CELLDATA_SLICES][SOC_ER_CELLDATA_SLICE_WORDS];
typedef uint32 soc_er_cd_columns_t[SOC_ER_CELLDATA_SLICES][SOC_ER_CELLDATA_SLICE_COLUMNS];
