/*
 * $Id: tunnel.h,v 1.20.6.1 Broadcom SDK $
 * 
...
/* Tunnel flags. */
#define BCM_TUNNEL_TERM_DSCP_TRUST      0x00000001 /* Trust incoming tunnel DSCP
                                                      inner or outer based on
                                                      USE_OUTER_DSCP flag. */
...
#define BCM_TUNNEL_TERM_KEEP_INNER_DSCP 0x00000008 /* Keep inner header DSCP. */
#define BCM_TUNNEL_INIT_USE_INNER_DF    0x00000010 /* Copy DF from inner header.
                                                      Note:flag takes precedence
                                                      over ipv4_set_df flag. */
#define BCM_TUNNEL_INIT_IPV4_SET_DF     0x00000020 /* Set DF bit in outer header
                                                      if inner header is IPv4. */
#define BCM_TUNNEL_INIT_IPV6_SET_DF     0x00000040 /* Set DF bit in outer header
                                                      if inner header is IPv6. */
#define BCM_TUNNEL_REPLACE              0x00000080 /* Update existing tunnel. */
...
typedef enum bcm_tunnel_type_e {
    bcmTunnelTypeNone,          /* Disable IP tunneling on specific interface. */
    bcmTunnelTypeIp4In4,        /* RFC 2003/2893: IPv4-in-IPv4 tunnel. */
    bcmTunnelTypeIp6In4,        /* RFC 2003/2893: IPv6-in-IPv4 tunnel. */
    bcmTunnelTypeIpAnyIn4,      /* RFC 2003/2893: IPv6/4-in-IPv4 tunnel. */
    bcmTunnelTypeIp4In6,        /* RFC 2003/2893: IPv4-in-IPv6 tunnel. */
    bcmTunnelTypeIp6In6,        /* RFC 2003/2893: IPv6-in-IPv6 tunnel. */
    bcmTunnelTypeIpAnyIn6,      /* RFC 2003/2893: IPv6/4-in-IPv6 tunnel. */
    bcmTunnelTypeGre4In4,       /* RFC 1701/2784/2890: GRE IPv4-in-IPv4 tunnel. */
    bcmTunnelTypeGre6In4,       /* RFC 1701/2784/2890: GRE IPv6-in-IPv4 tunnel. */
    bcmTunnelTypeGreAnyIn4,     /* RFC 1701/2784/2890: GRE IPv6/4-in-IPv4
                                   tunnel. */
    bcmTunnelTypeGre4In6,       /* RFC 1701/2784/2890: GRE IPv4-in-IPv6 tunnel. */
    bcmTunnelTypeGre6In6,       /* RFC 1701/2784/2890: GRE IPv6-in-IPv6 tunnel. */
    bcmTunnelTypeGreAnyIn6,     /* RFC 1701/2784/2890: GRE IPv6/4-in-IPv6
                                   tunnel. */
    bcmTunnelTypeIsatap,        /* RFC 4214: Intra-Site Automatic Tunnel
                                   Addressing Protocol. */
    bcmTunnelType6In4Uncheck,   /* RFC 3056: Configured connection of IPv6
                                   Domains via IPv4. */
    bcmTunnelType6In4,          /* RFC 3964: Checked 6to4 tunnel if supported by
                                   device otherwise unchecked 6to4 tunnel. */
    bcmTunnelTypeMpls,          /* RFC 3031: MPLS tunneling. */
    bcmTunnelTypeUdp,           /* UDP tunneling */
    bcmTunnelTypePimSmDr1,      /* Broadcom PIM SM Tunnel */
    bcmTunnelTypePimSmDr2,      /* Broadcom PIM SM Tunnel */
    bcmTunnelTypePim6SmDr1,     /* Broadcom PIM6 SM Tunnel */
    bcmTunnelTypePim6SmDr2,     /* Broadcom PIM6 SM Tunnel */
    bcmTunnelTypeCount          /* Must be last */
} bcm_tunnel_type_t;
...
typedef enum bcm_tunnel_dscp_select_e {
    bcmTunnelDscpAssign,    /* Set outer IP header DSCP to tunnel initiator DSCP
                               value. */
    bcmTunnelDscpPacket,    /* Copy packet DSCP to outer header. */
    bcmTunnelDscpMap,       /* Use DSCP value from DSCP map. */
    bcmTunnelDscpCount      /* Unused always last. */
