/*
 * $Id: failover.h,v 1.1.4.2 Broadcom SDK $
 * 
...
/* BCM_FAILOVER_* flags. */
#define BCM_FAILOVER_WITH_ID    (1 << 0)   /* flag to create a failover object
                                              whose Id is passed */

/* BCM_FAILOVER_* flags. */
#define BCM_FAILOVER_REPLACE    (1 << 1)   /* flag to update a failover object
                                              whose Id is passed */
