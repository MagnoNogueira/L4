 ...
 *
 * $Id: dispatch.h,v 1.239.2.24 Broadcom SDK $
...
typedef struct {
	...
	int (*cosq_gport_mapping_get)(int,bcm_gport_t,bcm_cos_t,bcm_cos_queue_t *);
	int (*cosq_gport_mapping_set)(int,bcm_gport_t,bcm_cos_t,bcm_cos_queue_t);
	int (*cosq_gport_nexus_attach)(int,bcm_gport_t,bcm_cos_queue_t,bcm_gport_t,bcm_cos_queue_t);
	int (*cosq_gport_nexus_detach)(int,bcm_gport_t,bcm_cos_queue_t,bcm_gport_t,bcm_cos_queue_t);
	...
	int (*custom_port_get)(int,bcm_port_t,int,uint32 [BCM_CUSTOM_ARGS_MAX]);
	int (*custom_port_set)(int,bcm_port_t,int,uint32 [BCM_CUSTOM_ARGS_MAX]);
	int (*custom_register)(int,bcm_custom_cb_t);
	int (*custom_unregister)(int);
	/* bcm_detach not dispatchable */
	int (*dmux_config_get)(int,bcm_port_t,uint32 *);
	int (*dmux_config_set)(int,bcm_port_t,uint32);
	int (*dmux_dest_add)(int,bcm_port_t,int,bcm_port_t);
	int (*dmux_dest_delete)(int,bcm_port_t,int,bcm_port_t);
	int (*dmux_dest_delete_all)(int,bcm_port_t);
	int (*dmux_dest_get)(int,bcm_port_t,int,bcm_pbmp_t *);
	int (*dmux_detach)(int);
	int (*dmux_init)(int);
	int (*ds_classifier_create)(int,int,bcm_ds_clfr_t *,bcm_ds_inprofile_actn_t *,bcm_ds_outprofile_actn_t *,bcm_ds_nomatch_actn_t *,int *);
	int (*ds_classifier_create_id)(int,int,bcm_ds_clfr_t *,bcm_ds_inprofile_actn_t *,bcm_ds_outprofile_actn_t *,bcm_ds_nomatch_actn_t *,int);
	int (*ds_classifier_delete)(int,int,int);
	int (*ds_classifier_get)(int,int,int,bcm_ds_clfr_t *,bcm_ds_inprofile_actn_t *,bcm_ds_outprofile_actn_t *,bcm_ds_nomatch_actn_t *);
	int (*ds_classifier_traverse)(int,int,bcm_ds_classifier_traverse_cb,void *);
	int (*ds_classifier_update)(int,int,int,uint32,bcm_ds_inprofile_actn_t *,bcm_ds_outprofile_actn_t *);
	/* bcm_ds_clfr_t_init not dispatchable */
	int (*ds_counter_get)(int,int,int,bcm_ds_counters_t *);
	/* bcm_ds_counters_t_init not dispatchable */
	int (*ds_datapath_create)(int,uint32,bcm_pbmp_t,int *);
	int (*ds_datapath_create_id)(int,uint32,bcm_pbmp_t,int);
	int (*ds_datapath_delete)(int,int);
	int (*ds_datapath_install)(int,int);
	int (*ds_dpid_cfid_bind)(int,void *,int,int);
	int (*ds_dpid_cfid_get)(int,void *,int,int *);
	int (*ds_dpid_cfid_unbind)(int,void *,int,int);
	int (*ds_init)(int);
	...
	int (*ds_scheduler_add)(int,int,bcm_ds_scheduler_t *);
	...
	int (*ffpcounter_create)(int,int,int *);
	int (*ffpcounter_delete)(int,int,int);
	int (*ffpcounter_delete_all)(int);
	int (*ffpcounter_get)(int,int,int,uint64 *);
	int (*ffpcounter_init)(int);
	int (*ffpcounter_set)(int,int,int,uint64);
	int (*ffppacketcounter_get)(int,int,int,uint64 *);
	int (*ffppacketcounter_set)(int,int,int,uint64);
	...
	int (*field_counter_create)(int,bcm_field_entry_t);
	int (*field_counter_destroy)(int,bcm_field_entry_t);
	int (*field_counter_get)(int,bcm_field_entry_t,int,uint64 *);
	int (*field_counter_get32)(int,bcm_field_entry_t,int,uint32 *);
	int (*field_counter_set)(int,bcm_field_entry_t,int,uint64);
	int (*field_counter_set32)(int,bcm_field_entry_t,int,uint32);
	int (*field_counter_share)(int,bcm_field_entry_t,bcm_field_entry_t);
	...
	int (*field_group_create_mode_slice_id)(int,bcm_field_qset_t,int,bcm_field_group_mode_t,bcm_field_group_t,bcm_field_group_sbmp_t);
#endif
...
#if 1/* anzhen.zheng, 5/26/2008 */
       int (*field_group_ports_create_mode_slice_id)(int,bcm_pbmp_t,bcm_field_qset_t,int,bcm_field_group_mode_t,bcm_field_group_t,	bcm_field_group_sbmp_t);
#endif
	...
	int (*field_group_satisfies_qset)(int,bcm_field_group_t,bcm_field_qset_t);
    ...
    int (*field_meter_control_set)(int, uint32);
	int (*field_meter_create)(int,bcm_field_entry_t);
	int (*field_meter_destroy)(int,bcm_field_entry_t);
	int (*field_meter_get)(int,bcm_field_entry_t,int,uint32 *,uint32 *);
	int (*field_meter_set)(int,bcm_field_entry_t,int,uint32,uint32);
	int (*field_meter_share)(int,bcm_field_entry_t,bcm_field_entry_t);
	int (*field_qset_add_udf)(int,bcm_field_qset_t *,bcm_field_udf_t);
	...
	int (*field_qualify_DstModid)(int,bcm_field_entry_t,bcm_module_t,bcm_module_t);
	int (*field_qualify_DstPort)(int,bcm_field_entry_t,bcm_module_t,bcm_module_t,bcm_port_t,bcm_port_t);
	int (*field_qualify_DstPortTgid)(int,bcm_field_entry_t,bcm_port_t,bcm_port_t);
	...
	int (*field_qualify_L3IntfGroup)(int,bcm_field_entry_t,bcm_if_group_t,bcm_if_group_t);
	...
	int (*field_qualify_LookupClass0)(int,bcm_field_entry_t,uint32,uint32);
	int (*field_qualify_LookupStatus)(int,bcm_field_entry_t,uint32,uint32);
	...
	int (*field_qualify_PacketFormat)(int,bcm_field_entry_t,uint32,uint32);
	int (*field_qualify_PacketRes)(int,bcm_field_entry_t,uint32,uint32);
	int (*field_qualify_PortClass)(int,bcm_field_entry_t,uint32,uint32);
	...
	int (*field_qualify_SrcMacGroup)(int,bcm_field_entry_t,uint32,uint32);
	int (*field_qualify_SrcModid)(int,bcm_field_entry_t,bcm_module_t,bcm_module_t);
	int (*field_qualify_SrcPort)(int,bcm_field_entry_t,bcm_module_t,bcm_module_t,bcm_port_t,bcm_port_t);
	int (*field_qualify_SrcPortTgid)(int,bcm_field_entry_t,bcm_port_t,bcm_port_t);
	...
	int (*field_qualify_UserDefined)(int,bcm_field_entry_t,bcm_field_udf_t,uint8 [BCM_FIELD_USER_FIELD_SIZE],uint8 [BCM_FIELD_USER_FIELD_SIZE]);
...
#endif	/* BROADCOM_DEBUG */
	int (*field_status_get)(int,bcm_field_status_t *);
	/* bcm_field_status_t_init not dispatchable */
	int (*field_udf_create)(int,bcm_field_udf_spec_t *,bcm_field_udf_t *);
	int (*field_udf_create_id)(int,bcm_field_udf_spec_t *,bcm_field_udf_t);
	int (*field_udf_destroy)(int,bcm_field_udf_t);
	int (*field_udf_ethertype_get)(int,int,bcm_port_frametype_t *,bcm_port_ethertype_t *);
	int (*field_udf_ethertype_set)(int,int,bcm_port_frametype_t,bcm_port_ethertype_t);
	int (*field_udf_get)(int,bcm_field_udf_spec_t *,bcm_field_udf_t);
	int (*field_udf_ipprotocol_get)(int,int,uint32 *,uint8 *);
	int (*field_udf_ipprotocol_set)(int,int,uint32,uint8);
	int (*field_udf_spec_get)(int,bcm_field_udf_spec_t *,uint32 *,uint32 *);
	int (*field_udf_spec_set)(int,bcm_field_udf_spec_t *,uint32,uint32);
	/* bcm_field_udf_spec_t_init not dispatchable */
	int (*filter_action_match)(int,bcm_filterid_t,bcm_filter_action_t,uint32);
	int (*filter_action_no_match)(int,bcm_filterid_t,bcm_filter_action_t,uint32);
	int (*filter_action_out_profile)(int,bcm_filterid_t,bcm_filter_action_t,uint32,int);
	int (*filter_copy)(int,bcm_filterid_t,bcm_filterid_t *);
	int (*filter_copy_id)(int,bcm_filterid_t,bcm_filterid_t);
	int (*filter_create)(int,bcm_filterid_t *);
	int (*filter_create_id)(int,bcm_filterid_t);
	int (*filter_destroy)(int,bcm_filterid_t);
#ifdef	BROADCOM_DEBUG
	int (*filter_dump)(int,bcm_filterid_t);
#endif	/* BROADCOM_DEBUG */
	int (*filter_init)(int);
	int (*filter_install)(int,bcm_filterid_t);
	int (*filter_qualify_broadcast)(int,bcm_filterid_t);
	int (*filter_qualify_data)(int,bcm_filterid_t,int,int,const uint8 *,const uint8 *);
	int (*filter_qualify_data16)(int,bcm_filterid_t,int,uint16,uint16);
	int (*filter_qualify_data32)(int,bcm_filterid_t,int,uint32,uint32);
	int (*filter_qualify_data8)(int,bcm_filterid_t,int,uint8,uint8);
	int (*filter_qualify_data_cvt)(int,bcm_filterid_t);
	int (*filter_qualify_egress)(int,bcm_filterid_t,bcm_pbmp_t);
	int (*filter_qualify_egress_modid)(int,bcm_filterid_t,int);
	int (*filter_qualify_format)(int,bcm_filterid_t,bcm_filter_format_t);
	int (*filter_qualify_ingress)(int,bcm_filterid_t,bcm_pbmp_t);
	int (*filter_qualify_known_mcast)(int,bcm_filterid_t);
	int (*filter_qualify_known_ucast)(int,bcm_filterid_t);
	int (*filter_qualify_priority)(int,bcm_filterid_t,int);
	int (*filter_qualify_stop)(int,bcm_filterid_t,int);
	int (*filter_qualify_unknown_mcast)(int,bcm_filterid_t);
	int (*filter_qualify_unknown_ucast)(int,bcm_filterid_t);
	int (*filter_reinstall)(int,bcm_filterid_t);
	int (*filter_remove)(int,bcm_filterid_t);
	int (*filter_remove_all)(int);
#ifdef	BROADCOM_DEBUG
	int (*filter_show)(int,const char *);
	/* bcm_find not dispatchable */
#endif	/* BROADCOM_DEBUG */
	int (*htls_egress_port_get)(int,bcm_port_t,int *,uint16 *,uint32 *);
	int (*htls_egress_port_set)(int,bcm_port_t,int,uint16,uint32);
	int (*htls_mode_get)(int,int *);
	int (*htls_mode_set)(int,int);
	int (*htls_tunnel_label_get)(int,bcm_port_t,uint32 *);
	int (*htls_tunnel_label_set)(int,bcm_port_t,uint32);
	int (*htls_uplink_da_get)(int,bcm_port_t,bcm_mac_t);
	int (*htls_uplink_da_set)(int,bcm_port_t,bcm_mac_t);
	int (*htls_uplink_sa_get)(int,bcm_port_t,bcm_mac_t);
	int (*htls_uplink_sa_set)(int,bcm_port_t,bcm_mac_t);
	int (*htls_vclabel_get)(int,bcm_port_t,uint32 *);
	int (*htls_vclabel_set)(int,bcm_port_t,uint32);
#ifdef	INCLUDE_I2C
...
#endif	/* INCLUDE_I2C */
	int (*igmp_snooping_enable_get)(int,int *);
	int (*igmp_snooping_enable_set)(int,int);
	int (*igmp_snooping_init)(int);
	int (*info_get)(int,bcm_info_t *);
	/* bcm_info_t_init not dispatchable */
	int (*init)(int);
	int (*init_check)(int);
	int (*init_phy_id_map)(int,int []);
	...
	int (*ipmc_add_l2_ports)(int,bcm_ip_t,bcm_ip_t,bcm_vlan_t,bcm_pbmp_t,bcm_pbmp_t);
	int (*ipmc_add_l3_ports)(int,bcm_ip_t,bcm_ip_t,bcm_vlan_t,bcm_pbmp_t);
	...
	int (*ipmc_cos_set)(int,bcm_ip_t,bcm_ip_t,bcm_vlan_t,int);
	int (*ipmc_counters_get)(int,bcm_port_t,bcm_ipmc_counters_t *);
	/* bcm_ipmc_counters_t_init not dispatchable */
	int (*ipmc_delete)(int,bcm_ip_t,bcm_ip_t,bcm_vlan_t,int);
	int (*ipmc_delete_all)(int);
	int (*ipmc_delete_l2_ports)(int,bcm_ip_t,bcm_ip_t,bcm_vlan_t,bcm_port_t);
	int (*ipmc_delete_l3_port)(int,bcm_ip_t,bcm_ip_t,bcm_vlan_t,bcm_port_t);
	int (*ipmc_detach)(int);
	int (*ipmc_egress_intf_add)(int,int,bcm_port_t,bcm_l3_intf_t *);
	int (*ipmc_egress_intf_delete)(int,int,bcm_port_t,bcm_l3_intf_t *);
	int (*ipmc_egress_intf_delete_all)(int,int,bcm_port_t);
	int (*ipmc_egress_intf_get)(int,int,bcm_port_t,int,bcm_if_t *,int *);
	int (*ipmc_egress_intf_set)(int,int,bcm_port_t,int,bcm_if_t *);
	...
	int (*ipmc_entry_enable_set)(int,bcm_ip_t,bcm_ip_t,bcm_vlan_t,int);
	int (*ipmc_find)(int,bcm_ipmc_addr_t *);
	int (*ipmc_get)(int,bcm_ip_t,bcm_ip_t,bcm_vlan_t,bcm_ipmc_addr_t *);
	int (*ipmc_get_by_index)(int,int,bcm_ipmc_addr_t *);
	int (*ipmc_init)(int);
	int (*ipmc_port_modid_set)(int,bcm_ip_t,bcm_ip_t,bcm_vlan_t,int);
	int (*ipmc_port_tgid_set)(int,bcm_ip_t,bcm_ip_t,bcm_vlan_t,int,int);
	int (*ipmc_remove)(int,bcm_ipmc_addr_t *);
	int (*ipmc_remove_all)(int);
	int (*ipmc_repl_add)(int,int,bcm_pbmp_t,bcm_vlan_t);
	int (*ipmc_repl_delete)(int,int,bcm_pbmp_t,bcm_vlan_t);
	int (*ipmc_repl_delete_all)(int,int,bcm_pbmp_t);
	int (*ipmc_repl_get)(int,int,bcm_port_t,bcm_vlan_vector_t);
	int (*ipmc_repl_set)(int,int,bcm_port_t,bcm_vlan_vector_t);
	int (*ipmc_source_ip_search)(int,int);
	int (*ipmc_source_port_check)(int,int);
	int (*ipmc_sport_mismatch_action)(int,bcm_ip_t,bcm_ip_t,bcm_vlan_t,int);
	int (*ipmc_traverse)(int,uint32,bcm_ipmc_traverse_cb,void *);
	int (*ipmc_ttl_threshold_set)(int,bcm_ip_t,bcm_ip_t,bcm_vlan_t,int);
#endif	/* INCLUDE_L3 */
	...
	int (*l2_bpdu_count)(int);
	int (*l2_bpdu_get)(int,int,bcm_mac_t *);
	int (*l2_bpdu_set)(int,int,bcm_mac_t);
...
#ifdef	INCLUDE_L3
	int (*l3_age)(int,uint32,bcm_l3_age_cb);
	int (*l3_cleanup)(int);
	int (*l3_conflict_get)(int,bcm_l3_key_t *,bcm_l3_key_t *,int,int *);
	int (*l3_defip_add)(int,bcm_l3_route_t *);
	int (*l3_defip_age)(int,bcm_l3_route_traverse_cb);
	int (*l3_defip_delete)(int,bcm_l3_route_t *);
	int (*l3_defip_delete_all)(int);
	int (*l3_defip_delete_by_interface)(int,int);
	int (*l3_defip_find_index)(int,int,bcm_l3_route_t *);
	int (*l3_defip_get)(int,bcm_l3_route_t *);
	int (*l3_defip_max_ecmp_get)(int,int *);
	int (*l3_defip_max_ecmp_set)(int,int);
	...
	int (*l3_ip4_enable_set)(int,int);
	int (*l3_ip6_enable_set)(int,int);
	...
	int (*l3_init)(int);
	int (*l3_interface_create)(int,bcm_mac_t,bcm_vlan_t,int);
	int (*l3_interface_destroy)(int,int);
	int (*l3_interface_find)(int,int,bcm_vlan_t *,bcm_mac_t);
	int (*l3_interface_find_by_vlan)(int,bcm_vlan_t,int *);
	int (*l3_interface_id_create)(int,bcm_mac_t,bcm_vlan_t,int,int);
	int (*l3_interface_id_update)(int,bcm_mac_t,bcm_vlan_t,int,int);
	int (*l3_interface_lookup)(int,bcm_mac_t,bcm_vlan_t,int *);
	...
	int (*l3_invalidate_entry)(int,bcm_ip_t);
	...
	int (*l3_ip_add)(int,bcm_l3_ip_t *);
	int (*l3_ip_delete)(int,bcm_ip_t);
	int (*l3_ip_delete_all)(int);
	int (*l3_ip_delete_by_interface)(int,int);
	int (*l3_ip_delete_by_prefix)(int,bcm_ip_t,bcm_ip_t);
	int (*l3_ip_find)(int,bcm_l3_ip_t *);
	int (*l3_ip_find_index)(int,int,bcm_l3_ip_t *);
	int (*l3_ip_update_entry_by_key)(int,bcm_l3_ip_t *);
	...
	int (*l3_status)(int,int *,int *,int *,int *);
	int (*l3_untagged_update)(int);
	int (*l3_validate_entry)(int,bcm_ip_t);
#endif	/* INCLUDE_L3 */
	...
	int (*meter_create)(int,int,int *);
	int (*meter_delete)(int,int,int);
	int (*meter_delete_all)(int);
	int (*meter_get)(int,int,int,uint32 *,uint32 *);
	int (*meter_init)(int);
	int (*meter_set)(int,int,int,uint32,uint32);
	...
	int (*mirror_egress_path_get)(int,bcm_module_t,bcm_port_t *);
	int (*mirror_egress_path_set)(int,bcm_module_t,bcm_port_t);
	...
	int (*mirror_pfmt_get)(int,int *);
	int (*mirror_pfmt_set)(int,int);
	...
	int (*mpls_info)(int,bcm_mpls_info_t *);
	/* bcm_mpls_info_t_init not dispatchable */
	int (*mpls_init)(int);
	int (*mpls_l3_initiator_clear)(int,bcm_l3_intf_t *);
	int (*mpls_l3_initiator_clear_all)(int);
	int (*mpls_l3_initiator_get)(int,bcm_l3_intf_t *,bcm_mpls_l3_initiator_t *);
	int (*mpls_l3_initiator_set)(int,bcm_l3_intf_t *,bcm_mpls_l3_initiator_t *);
	...
	int (*mpls_port_block_get)(int,bcm_vpn_t,bcm_port_t,int *);
	int (*mpls_port_block_set)(int,bcm_vpn_t,bcm_port_t,int);
	...
	int (*mpls_switch_add)(int,bcm_mpls_switch_t *);
	int (*mpls_switch_delete)(int,bcm_mpls_switch_t *);
	int (*mpls_switch_delete_all)(int,int);
	int (*mpls_switch_get)(int,bcm_mpls_switch_t *);
	/* bcm_mpls_switch_t_init not dispatchable */
	int (*mpls_switch_traverse)(int,uint32,uint32,uint32,bcm_mpls_switch_traverse_cb,void *);
	...
	int (*mpls_vpn_add)(int,bcm_vpn_t,bcm_mpls_vpn_t *);
	int (*mpls_vpn_circuit_add)(int,bcm_vpn_t,bcm_mpls_circuit_t *);
	int (*mpls_vpn_circuit_delete)(int,bcm_vpn_t,bcm_mpls_circuit_t *);
	int (*mpls_vpn_circuit_delete_all)(int,bcm_vpn_t);
	int (*mpls_vpn_circuit_get)(int,bcm_vpn_t,int,bcm_mpls_circuit_t *,int *);
	/* bcm_mpls_vpn_config_t_init not dispatchable */
	int (*mpls_vpn_create)(int,bcm_vpn_t,uint32);
	int (*mpls_vpn_delete)(int,bcm_vpn_t,bcm_mpls_vpn_t *);
	int (*mpls_vpn_delete_all)(int,bcm_vpn_t);
	int (*mpls_vpn_destroy)(int,bcm_vpn_t);
	int (*mpls_vpn_get)(int,bcm_vpn_t,int,bcm_mpls_vpn_t *,int *);
	...
	int (*oam_ccm_endpoint_add)(int,bcm_oam_ccm_t *);
	int (*oam_ccm_endpoint_delete)(int,bcm_oam_ccm_t *);
	int (*oam_ccm_endpoint_delete_all)(int,bcm_oam_ccm_t *);
	int (*oam_ccm_endpoint_get)(int,bcm_oam_ccm_t *);
	int (*oam_ccm_register)(int,bcm_oam_ccm_timeout_cb_t);
	/* bcm_oam_ccm_t_init not dispatchable */
	int (*oam_ccm_traverse)(int,uint32,int,int,bcm_oam_ccm_traverse_cb_t,void *);
	int (*oam_ccm_unregister)(int,bcm_oam_ccm_timeout_cb_t);
	int (*oam_detach)(int);
	int (*oam_init)(int);
	...
	int (*policer_stat_get)(int,bcm_policer_t,bcm_policer_stat_t,uint64 *);
	int (*policer_stat_get32)(int,bcm_policer_t,bcm_policer_stat_t,uint32 *);
	int (*policer_stat_set)(int,bcm_policer_t,bcm_policer_stat_t,uint64);
	int (*policer_stat_set32)(int,bcm_policer_t,bcm_policer_stat_t,uint32);
	...
	int (*egress_packet_ifg_set)(int, uint32);
	...
	int (*stk_sl_simplex_count_get)(int,int *);
	int (*stk_sl_simplex_count_set)(int,int);
	...
	int (*trunk_create)(int,bcm_trunk_t *);
	int (*trunk_create_id)(int,bcm_trunk_t);
	...
	int (*trunk_get)(int,bcm_trunk_t,bcm_trunk_add_info_t *);
	int (*trunk_init)(int);
	...
	int (*trunk_set)(int,bcm_trunk_t,bcm_trunk_add_info_t *);
#ifdef	INCLUDE_L3
	...
	int (*vlan_init)(int);
	int (*vlan_ip4_add)(int,bcm_ip_t,bcm_ip_t,bcm_vlan_t,int);
	int (*vlan_ip4_delete)(int,bcm_ip_t,bcm_ip_t);
	int (*vlan_ip4_delete_all)(int);
	...
	int (*vlan_port_create)(int,uint32,bcm_vlan_port_t,bcm_gport_t *);
	...
	int (*vpls_bitmap_add)(int,uint32,bcm_vlan_t,bcm_pbmp_t);
	int (*vpls_bitmap_delete)(int,uint32);
	int (*vpls_bitmap_delete_all)(int);
	int (*vpls_bitmap_detach)(int);
	int (*vpls_bitmap_get)(int,uint32,bcm_vlan_t *,bcm_pbmp_t *);
	int (*vpls_bitmap_init)(int);
    ...
    int (*accton_bcm_field_entry_copy_id)(int,bcm_field_group_t,bcm_field_entry_t);
	int (*port_phy_ioctl)(int,int,unsigned int,void *);
} bcm_dispatch_t;
