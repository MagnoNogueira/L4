/*
 * $Id: draco.h,v 1.47.2.2 Broadcom SDK $
...
extern int bcm_draco_l2_addr_delete_by_mac_port(int, bcm_mac_t,
					 ...
					 uint32);
extern int _bcm_draco_l2_addr_replace_by_mac(int unit, uint32 flags, _bcm_l2_replace_t *rep_st);
extern int _bcm_draco_l2_addr_replace_by_vlan_dest(int unit, uint32 flags, _bcm_l2_replace_t *rep_st);

extern int bcm_draco_l2_addr_delete_mcast(int unit, uint32 flags);
extern int bcm_draco_l2_addr_register(int, bcm_l2_addr_callback_t, void*);
extern int bcm_draco_l2_addr_unregister(int, bcm_l2_addr_callback_t, void*);
extern int bcm_draco_l2_conflict_get(int, bcm_l2_addr_t *, bcm_l2_addr_t *,
			      int, int *);

extern int bcm_draco_vlan_init(int, bcm_vlan_data_t *);
extern int bcm_draco_vlan_reload(int, vlist_t **, int *);
...
extern int bcm_draco_vlan_port_get(int, bcm_vlan_t,
			    bcm_pbmp_t *pbmp, bcm_pbmp_t *ubmp);
extern int bcm_draco_vlan_of_port(int, bcm_port_t, vtable_entry_t *);
...
extern int bcm_draco_cosq_detach(int unit);
