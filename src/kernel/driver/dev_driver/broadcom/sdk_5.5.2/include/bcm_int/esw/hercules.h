/*
 * $Id: hercules.h,v 1.35 Broadcom SDK $
...
extern int bcm_hercules_l2_addr_delete_by_mac_port(int, bcm_mac_t,
					    ...
					    uint32);
extern int bcm_hercules_l2_addr_register(int, bcm_l2_addr_callback_t, void*);
extern int bcm_hercules_l2_addr_unregister(int, bcm_l2_addr_callback_t, void*);
...
extern int bcm_hercules_vlan_reload(int, vlist_t **, int *);
...
extern int bcm_hercules_vlan_port_add(int, bcm_vlan_t,
			       bcm_pbmp_t, bcm_pbmp_t);
extern int bcm_hercules_vlan_port_remove(int, bcm_vlan_t, bcm_pbmp_t);
extern int bcm_hercules_vlan_port_get(int, bcm_vlan_t,
			       bcm_pbmp_t *pbmp, bcm_pbmp_t *ubmp);
extern int bcm_hercules_vlan_of_port(int, bcm_port_t, vtable_entry_t *);
...
extern int bcm_hercules_trunk_set(int, bcm_trunk_t,
...
extern int bcm_hercules_cosq_detach(int unit);
...
extern int bcm_hercules_l3_age(int unit, uint32 flags, bcm_l3_host_traverse_cb
                               age_out, void *);
extern int bcm_hercules_l3_traverse(int unit, uint32 start, uint32 end,
...
extern int bcm_hercules_l3_ip6_traverse(int unit, uint32 start, uint32 end,
                      bcm_l3_host_traverse_cb cb, void *user_data);
