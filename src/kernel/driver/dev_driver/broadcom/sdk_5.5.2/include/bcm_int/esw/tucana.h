/*
 * $Id: tucana.h,v 1.12 Broadcom SDK $
...
extern int bcm_tucana_vlan_reload(int, vlist_t **, int *);
...
extern int bcm_tucana_vlan_port_get(int, bcm_vlan_t,
			     bcm_pbmp_t *pbmp, bcm_pbmp_t *ubmp);
extern int bcm_tucana_vlan_of_port(int, bcm_port_t, vtable_entry_t *);
extern int bcm_tucana_vlan_list(int, bcm_vlan_data_t **, int *);

extern int bcm_tucana_cosq_init(int unit);
extern int bcm_tucana_cosq_detach(int unit);
