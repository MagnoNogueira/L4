...
typedef int (*mbcm_vlan_reload_f)(int, vlist_t **, int *);
...
typedef int (*mbcm_vlan_port_remove_f)(int, bcm_vlan_t, bcm_pbmp_t);
typedef int (*mbcm_vlan_port_get_f)(int, bcm_vlan_t,
...
/* trunking function */
typedef int (*mbcm_trunk_set_f)(int, bcm_trunk_t,
...
typedef int (*mbcm_cosq_detach_f)(int unit);
...
/* Meter functions */
typedef int (*mbcm_meter_init_f)(int unit);
typedef int (*mbcm_meter_create_f)(int unit, int port, int *mid);
typedef int (*mbcm_meter_delete_f)(int unit, int port, int mid);
typedef int (*mbcm_meter_delete_all_f)(int unit);
typedef int (*mbcm_meter_get_f)(int unit, int port, int mid,
                                uint32 *kbits_sec, uint32 *kbits_burst);
typedef int (*mbcm_meter_set_f)(int unit, int port, int mid,
                                uint32 kbits_sec, uint32 kbits_burst);
typedef int (*mbcm_ffppacketcounter_set_f)(int unit, int port, int mid,
                                           uint64 val);
typedef int (*mbcm_ffppacketcounter_get_f)(int unit, int port, int mid,
                                           uint64 *val);
typedef int (*mbcm_ffpcounter_init_f)(int unit);
typedef int (*mbcm_ffpcounter_create_f)(int unit, int port, int *ffpcounterid);
typedef int (*mbcm_ffpcounter_delete_f)(int unit, int port, int ffpcounterid);
typedef int (*mbcm_ffpcounter_delete_all_f)(int unit);
typedef int (*mbcm_ffpcounter_set_f)(int unit, int port, int ffpcounterid,
                                     uint64 val);
typedef int (*mbcm_ffpcounter_get_f)(int unit, int port, int ffpcounterid,
                                     uint64 *val);
typedef int (*mbcm_egress_packet_ifg_set_f)(int unit, uint32 value);
...
typedef int (*mbcm_l3_ip4_enable_f)(int, int);
typedef int (*mbcm_l3_ip6_enable_f)(int, int);
...
typedef int (*mbcm_l3_traverse_f)(int, uint32, uint32,
...
typedef int (*mbcm_lpm_defip_sw_tbl_empty_f)(int, int *);
typedef int (*mbcm_lpm_defip_hw_tbl_empty_f)(int, int *);
typedef int (*mbcm_lpm_check_table_f)(int);
typedef int (*mbcm_lpm_delete_f)(int, _bcm_defip_cfg_t *);
typedef int (*mbcm_lpm_insert_f)(int, _bcm_defip_cfg_t *);
typedef int (*mbcm_lpm_lookup_f)(int, ip_addr_t, _bcm_defip_cfg_t *);
...
typedef int (*mbcm_ipmc_egress_port_get_f)(int, bcm_port_t, mac_addr_t,
                                           int *, bcm_vlan_t *, int *);
...
typedef struct mbcm_functions_s {
    ...
    mbcm_l2_addr_delete_by_mac_f	mbcm_l2_addr_delete_by_mac;
    mbcm_l2_addr_delete_by_mac_port_f	mbcm_l2_addr_delete_by_mac_port;
    mbcm_l2_addr_register_f	    mbcm_l2_addr_register;
    mbcm_l2_addr_unregister_f	    mbcm_l2_addr_unregister;
    ...
    /* trunking */
    mbcm_trunk_set_f                mbcm_trunk_set;
    ...
    /* Meter functions */
    mbcm_meter_init_f               mbcm_meter_init;
    mbcm_meter_create_f             mbcm_meter_create;
    mbcm_meter_delete_f             mbcm_meter_delete;
    mbcm_meter_delete_all_f         mbcm_meter_delete_all;
    mbcm_meter_get_f                mbcm_meter_get;
    mbcm_meter_set_f                mbcm_meter_set;
    mbcm_ffppacketcounter_set_f     mbcm_ffppacketcounter_set;
    mbcm_ffppacketcounter_get_f     mbcm_ffppacketcounter_get;
    mbcm_ffpcounter_init_f          mbcm_ffpcounter_init;
    mbcm_ffpcounter_create_f        mbcm_ffpcounter_create;
    mbcm_ffpcounter_delete_f        mbcm_ffpcounter_delete;
    mbcm_ffpcounter_delete_all_f    mbcm_ffpcounter_delete_all;
    mbcm_ffpcounter_set_f           mbcm_ffpcounter_set;
    mbcm_ffpcounter_get_f           mbcm_ffpcounter_get;
    mbcm_egress_packet_ifg_set_f    mbcm_egress_packet_ifg_set;
    ...
    mbcm_l3_ip4_enable_f            mbcm_l3_ip4_enable;
    mbcm_l3_ip6_enable_f            mbcm_l3_ip6_enable;
    ...
    /* XGS1 function */
    mbcm_lpm_defip_sw_tbl_empty_f   mbcm_lpm_defip_sw_tbl_empty;
    mbcm_lpm_defip_hw_tbl_empty_f   mbcm_lpm_defip_hw_tbl_empty;
    mbcm_lpm_check_table_f          mbcm_lpm_check_table;
    mbcm_lpm_delete_f               mbcm_lpm_delete;
    mbcm_lpm_insert_f               mbcm_lpm_insert;
    mbcm_lpm_lookup_f               mbcm_lpm_lookup;
...
extern mbcm_functions_t mbcm_strata_driver;
extern mbcm_functions_t mbcm_allayer_driver;
extern mbcm_functions_t mbcm_draco_driver;
extern mbcm_functions_t mbcm_hercules_driver;
extern mbcm_functions_t mbcm_lynx_driver;
extern mbcm_functions_t mbcm_tucana_driver;
extern mbcm_functions_t mbcm_easyrider_driver;
