/*
 * $Id: control.h,v 1.12.6.1 Broadcom SDK $
...
#define	BCM_CONTROL_MAX	(BCM_UNITS_MAX - 1) 
#endif

typedef struct {
    bcm_dispatch_t	*dispatch;	/* function dispatch table */
...
#define		BCM_UNIT_VALID(_unit)	((_unit) >= 0 && \
					 (_unit) < BCM_CONTROL_MAX && \
					 BCM_CONTROL(_unit) != 0)
