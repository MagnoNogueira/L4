/*
 * $Id: easyrider.h,v 1.72.2.5 Broadcom SDK $
...
extern int _bcm_er_l2_addr_get(int unit, mac_addr_t mac, bcm_vlan_t vid,
                               bcm_l2_addr_t *l2addr, bcm_pbmp_t *pbm);
...
extern int bcm_er_l2_addr_register(int unit, bcm_l2_addr_callback_t cb, void *data);
extern int bcm_er_l2_addr_unregister(int unit, bcm_l2_addr_callback_t cb, void *data);
...
extern int bcm_er_mcast_addr_remove(int unit, mac_addr_t mac, bcm_vlan_t vid);
extern int bcm_er_mcast_addr_remove_w_l2mcindex(int unit,
                                                bcm_mcast_addr_t *mcaddr);
extern int bcm_er_mcast_port_get(int unit, mac_addr_t mac, bcm_vlan_t vid,
                                 bcm_mcast_addr_t *mcaddr);
...
extern int bcm_er_cosq_detach(int unit);
...
int bcm_er_vlan_translate_add(int unit, int port, bcm_module_t modid, 
                              bcm_vlan_t old_vid, bcm_vlan_t new_vid, 
                              int prio, int xtable);
int bcm_er_vlan_translate_get(int unit, int port, bcm_module_t modid, bcm_vlan_t old_vid,
