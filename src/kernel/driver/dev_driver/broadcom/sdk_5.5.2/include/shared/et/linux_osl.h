 ...
 * $Id: linux_osl.h,v 1.2.120.1 Broadcom SDK $
 */
...
/* gordon_kao: comment for unresolved symbol */
#if 0
...
#else
#define OSL_PCMCIA_READ_ATTR(osh, offset, buf, size)    (0)
#define OSL_PCMCIA_WRITE_ATTR(osh, offset, buf, size)   (0)
#define OSL_PCI_READ_CONFIG(loc, offset, size)          (0)
#define OSL_PCI_WRITE_CONFIG(loc, offset, size, val)    (0)
#endif
...
#define MFREE(addr, size)	kfree((void*)(addr))
/* gordon_kao: below codes will cause unresolved symbol in kernel module
 */
#if 0
