/*
 * $Id: pci.h,v 1.14.6.1 Broadcom SDK $
...
extern int pci_dma_putw(pci_dev_t *, uint32 addr, uint32 data);
extern int pci_dma_puth(pci_dev_t *, uint32 addr, uint16 data);
extern int pci_dma_putb(pci_dev_t *, uint32 addr, uint8 data);

extern uint32 pci_dma_getw(pci_dev_t *, uint32 addr);
extern uint16 pci_dma_geth(pci_dev_t *, uint32 addr);
extern uint8 pci_dma_getb(pci_dev_t *, uint32 addr);
