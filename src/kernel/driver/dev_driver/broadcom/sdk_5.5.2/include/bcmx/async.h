 ...
 *
 * $Id: async.h,v 1.140.2.15 Broadcom SDK $
 ...
 * Generated:	Tue Dec 11 19:03:13 2007
 */
...
void	bcmx_custom_port_get_async(bcmx_lport_t port, int type, uint32 args[BCM_CUSTOM_ARGS_MAX], bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_custom_port_set_async(bcmx_lport_t port, int type, uint32 args[BCM_CUSTOM_ARGS_MAX], bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_custom_unit_get_async(int type, uint32 args[BCM_CUSTOM_ARGS_MAX], bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_custom_unit_set_async(int type, uint32 args[BCM_CUSTOM_ARGS_MAX], bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_device_attach_async(int bcm_unit, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_device_detach_async(int bcm_unit, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ds_classifier_alloc_create_async(int dpid, int * cfid, bcm_ds_clfr_t * clfr, bcm_ds_inprofile_actn_t * inp_actn, bcm_ds_outprofile_actn_t * outp_actn, bcm_ds_nomatch_actn_t * nm_actn, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ds_classifier_create_async(int dpid, int cfid, bcm_ds_clfr_t * clfr, bcm_ds_inprofile_actn_t * inp_actn, bcm_ds_outprofile_actn_t * outp_actn, bcm_ds_nomatch_actn_t * nm_actn, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ds_classifier_delete_async(int dpid, int cfid, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ds_classifier_get_async(int dpid, int cfid, bcm_ds_clfr_t * clfr, bcm_ds_inprofile_actn_t * inp_actn, bcm_ds_outprofile_actn_t * outp_actn, bcm_ds_nomatch_actn_t * nm_actn, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ds_classifier_update_async(int dpid, int cfid, uint32 flags, bcm_ds_inprofile_actn_t * inp_actn, bcm_ds_outprofile_actn_t * outp_actn, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ds_counter_get_async(int dpid, int cfid, bcm_ds_counters_t * counter, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ds_datapath_alloc_create_async(int * dpid, uint32 flags, bcmx_lplist_t plist, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ds_datapath_create_async(int dpid, uint32 flags, bcmx_lplist_t plist, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ds_datapath_delete_async(int dpid, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ds_datapath_install_async(int dpid, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ds_datapath_unit_count_async(int dpid, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ds_init_async(bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ds_scheduler_add_async(int dpid, bcm_ds_scheduler_t * scheduler, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ffpcounter_create_async(bcmx_lport_t lport, int * ffpcounterid, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ffpcounter_delete_async(bcmx_lport_t lport, int ffpcounterid, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ffpcounter_delete_all_async(bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ffpcounter_get_async(bcmx_lport_t lport, int ffpcounterid, uint64 * val, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ffpcounter_init_async(bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ffpcounter_set_async(bcmx_lport_t lport, int ffpcounterid, uint64 val, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ffppacketcounter_get_async(bcmx_lport_t lport, int mid, uint64 * val, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ffppacketcounter_set_async(bcmx_lport_t lport, int mid, uint64 val, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_field_counter_create_async(bcm_field_entry_t entry, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_field_counter_destroy_async(bcm_field_entry_t entry, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_field_counter_get_async(bcm_field_entry_t entry, int counter_num, uint64 * valp, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_field_counter_get32_async(bcm_field_entry_t entry, int counter_num, uint32 * valp, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_field_counter_set_async(bcm_field_entry_t entry, int counter_num, uint64 val, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_field_counter_set32_async(bcm_field_entry_t entry, int counter_num, uint32 val, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_field_counter_share_async(bcm_field_entry_t src_entry, bcm_field_entry_t dst_entry, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_field_meter_create_async(bcm_field_entry_t entry, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_field_meter_destroy_async(bcm_field_entry_t entry, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_field_meter_get_async(bcm_field_entry_t entry, int meter_num, uint32 * kbits_sec, uint32 * kbits_burst, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_field_meter_set_async(bcm_field_entry_t entry, int meter_num, uint32 kbits_sec, uint32 kbits_burst, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_field_meter_share_async(bcm_field_entry_t src_entry, bcm_field_entry_t dst_entry, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_field_qset_add_udf_async(bcm_field_qset_t * qset, bcm_field_udf_t udf_id, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_field_qualify_DstModid_async(bcm_field_entry_t entry, bcm_module_t data, bcm_module_t mask, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_field_qualify_L3IntfGroup_async(bcm_field_entry_t entry, bcm_if_group_t data, bcm_if_group_t mask, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_field_qualify_LookupClass0_async(bcm_field_entry_t entry, uint32 data, uint32 mask, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_field_qualify_LookupStatus_async(bcm_field_entry_t entry, uint32 data, uint32 mask, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_field_qualify_PacketFormat_async(bcm_field_entry_t entry, uint32 data, uint32 mask, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_field_qualify_PortClass_async(bcm_field_entry_t entry, uint32 data, uint32 mask, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_field_qualify_SrcMacGroup_async(bcm_field_entry_t entry, uint32 data, uint32 mask, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_field_qualify_SrcModid_async(bcm_field_entry_t entry, bcm_module_t data, bcm_module_t mask, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_field_qualify_Stage_async(bcm_field_entry_t entry, bcm_field_stage_t stage, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_field_qualify_UserDefined_async(bcm_field_entry_t entry, bcm_field_udf_t udf_id, uint8 * data, uint8 * mask, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_field_udf_create_async(bcm_field_udf_spec_t * udf_spec, bcm_field_udf_t * udf_id, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_field_udf_create_id_async(bcm_field_udf_spec_t * udf_spec, bcm_field_udf_t udf_id, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_field_udf_destroy_async(bcm_field_udf_t udf_id, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_field_udf_ethertype_get_async(int index, bcm_port_frametype_t * frametype, bcm_port_ethertype_t * ethertype, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_field_udf_ethertype_set_async(int index, bcm_port_frametype_t frametype, bcm_port_ethertype_t ethertype, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_field_udf_get_async(bcm_field_udf_spec_t * udf_spec, bcm_field_udf_t udf_id, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_field_udf_ipprotocol_get_async(int index, uint32 * flags, uint8 * proto, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_field_udf_ipprotocol_set_async(int index, uint32 flags, uint8 proto, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_field_udf_spec_get_async(bcm_field_udf_spec_t * udf_spec, uint32 * flags, uint32 * offset, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_field_udf_spec_set_async(bcm_field_udf_spec_t * udf_spec, uint32 flags, uint32 offset, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_filter_action_match_async(bcm_filterid_t f, bcm_filter_action_t action, uint32 param, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_filter_action_no_match_async(bcm_filterid_t f, bcm_filter_action_t action, uint32 param, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_filter_action_out_profile_async(bcm_filterid_t f, bcm_filter_action_t action, uint32 param, int meter_id, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_filter_copy_async(bcm_filterid_t f_src, bcm_filterid_t * f_return, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_filter_create_async(bcm_filterid_t * f_return, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_filter_create_id_async(bcm_filterid_t f, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_filter_destroy_async(bcm_filterid_t f, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_filter_init_async(bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_filter_install_async(bcm_filterid_t f, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_filter_qualify_broadcast_async(bcm_filterid_t f, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_filter_qualify_data_async(bcm_filterid_t f, int offset, int len, const uint8 * data, const uint8 * mask, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_filter_qualify_data16_async(bcm_filterid_t f, int offset, uint16 val, uint16 mask, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_filter_qualify_data32_async(bcm_filterid_t f, int offset, uint32 val, uint32 mask, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_filter_qualify_data8_async(bcm_filterid_t f, int offset, uint8 val, uint8 mask, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_filter_qualify_data_cvt_async(bcm_filterid_t f, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_filter_qualify_egress_async(bcm_filterid_t f, bcmx_lplist_t lplist, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_filter_qualify_egress_modid_async(bcm_filterid_t f, int module_id, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_filter_qualify_format_async(bcm_filterid_t f, bcm_filter_format_t format, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_filter_qualify_ingress_async(bcm_filterid_t f, bcmx_lplist_t lplist, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_filter_qualify_known_mcast_async(bcm_filterid_t f, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_filter_qualify_known_ucast_async(bcm_filterid_t f, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_filter_qualify_priority_async(bcm_filterid_t f, int prio, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_filter_qualify_stop_async(bcm_filterid_t f, int partial_match, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_filter_qualify_unknown_mcast_async(bcm_filterid_t f, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_filter_qualify_unknown_ucast_async(bcm_filterid_t f, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_filter_reinstall_async(bcm_filterid_t f, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_filter_remove_async(bcm_filterid_t f, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_filter_remove_all_async(bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_igmp_snooping_enable_get_async(int * enable, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_igmp_snooping_enable_set_async(int enable, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_igmp_snooping_init_async(bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_ipmc_add_l2_ports_async(bcm_ip_t s_ip_addr, bcm_ip_t mc_ip_addr, bcm_vlan_t vid, bcmx_lplist_t lplist, bcmx_lplist_t ut_lplist, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ipmc_add_l3_ports_async(bcm_ip_t s_ip_addr, bcm_ip_t mc_ip_addr, bcm_vlan_t vid, bcmx_lplist_t lplist, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_ipmc_cos_set_async(bcm_ip_t s_ip_addr, bcm_ip_t mc_ip_addr, bcm_vlan_t vid, int cos, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_ipmc_delete_async(bcm_ip_t s_ip_addr, bcm_ip_t mc_ip_addr, bcm_vlan_t vid, int keep, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ipmc_delete_all_async(bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ipmc_delete_l2_ports_async(bcm_ip_t s_ip_addr, bcm_ip_t mc_ip_addr, bcm_vlan_t vid, bcmx_lport_t port, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ipmc_delete_l3_port_async(bcm_ip_t s_ip_addr, bcm_ip_t mc_ip_addr, bcm_vlan_t vid, bcmx_lport_t port, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ipmc_detach_async(bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ipmc_egress_intf_add_async(int group, bcmx_lport_t port, bcm_l3_intf_t * l3_intf, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ipmc_egress_intf_delete_async(int group, bcmx_lport_t port, bcm_l3_intf_t * l3_intf, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ipmc_egress_intf_delete_all_async(int group, bcmx_lport_t port, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ipmc_egress_intf_get_async(int group, bcmx_lport_t port, int if_max, bcm_if_t * if_array, int * if_count, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ipmc_egress_intf_set_async(int group, bcmx_lport_t port, int if_count, bcm_if_t * if_array, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_ipmc_entry_enable_set_async(bcm_ip_t s_ip_addr, bcm_ip_t mc_ip_addr, bcm_vlan_t vid, int enable, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ipmc_find_async(bcmx_ipmc_addr_t * data, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ipmc_get_async(bcm_ip_t s_ip_addr, bcm_ip_t mc_ip_addr, bcm_vlan_t vid, bcmx_ipmc_addr_t * data, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ipmc_get_by_index_async(int index, bcmx_ipmc_addr_t * data, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ipmc_init_async(bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ipmc_port_tgid_set_async(bcm_ip_t s_ip_addr, bcm_ip_t mc_ip_addr, bcm_vlan_t vid, int ts, int port_tgid, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_ipmc_repl_add_async(int index, bcmx_lplist_t lplist, bcm_vlan_t vlan, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ipmc_repl_delete_async(int index, bcmx_lplist_t lplist, bcm_vlan_t vlan, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ipmc_repl_delete_all_async(int index, bcmx_lplist_t lplist, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ipmc_repl_get_async(int index, bcmx_lport_t port, bcm_vlan_vector_t vlan_vec, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ipmc_repl_set_async(int index, bcmx_lport_t port, bcm_vlan_vector_t vlan_vec, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ipmc_source_ip_search_async(int enable, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ipmc_source_port_check_async(int enable, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_ipmc_sport_mismatch_action_async(bcm_ip_t s_ip_addr, bcm_ip_t mc_ip_addr, bcm_vlan_t vid, int cd, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_ipmc_ttl_threshold_set_async(bcm_ip_t s_ip_addr, bcm_ip_t mc_ip_addr, bcm_vlan_t vid, int ttl_threshold, bcmx_async_cb_t async_callback, void *async_cookie);
#endif	/* INCLUDE_L3 */
...
void	bcmx_l2_bpdu_count_async(bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_l2_bpdu_get_async(int index, bcm_mac_t * addr, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_l2_bpdu_set_async(int index, bcm_mac_t addr, bcmx_async_cb_t async_callback, void *async_cookie);
/* bcmx_l2_cache_addr_t_free has a non int return type */
/* bcmx_l2_cache_addr_t_init has a non int return type */
...
#ifdef	INCLUDE_L3
void	bcmx_l3_age_async(uint32 flags, bcm_l3_age_cb age_out, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_l3_cleanup_async(bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_l3_conflict_get_async(bcm_l3_key_t * ipkey, bcm_l3_key_t * cf_array, int cf_max, int * cf_count, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_l3_defip_add_async(bcmx_l3_route_t * info, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_l3_defip_age_async(bcm_l3_route_traverse_cb age_out, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_l3_defip_delete_async(bcmx_l3_route_t * info, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_l3_defip_delete_all_async(bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_l3_defip_delete_by_interface_async(int intf, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_l3_defip_get_async(bcmx_l3_route_t * info, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_l3_defip_max_ecmp_get_async(int * max, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_l3_defip_max_ecmp_set_async(int max, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_l3_interface_create_async(bcm_mac_t mac_addr, bcm_vlan_t vid, int add_to_arl, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_l3_interface_destroy_async(int interface, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_l3_interface_find_async(int interface, bcm_vlan_t * vid, bcm_mac_t mac_addr, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_l3_interface_find_by_vlan_async(bcm_vlan_t vid, int * interface, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_l3_interface_id_create_async(bcm_mac_t mac_addr, bcm_vlan_t vid, int intf_idx, int add_to_arl, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_l3_interface_id_update_async(bcm_mac_t mac_addr, bcm_vlan_t vid, int intf_idx, int add_to_arl, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_l3_interface_lookup_async(bcm_mac_t mac_addr, bcm_vlan_t vid, int * intf_id, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_l3_invalidate_entry_async(bcm_ip_t l3_addr, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_l3_ip_add_async(bcmx_l3_ip_t * info, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_l3_ip_delete_async(bcm_ip_t ip_addr, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_l3_ip_delete_all_async(bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_l3_ip_delete_by_interface_async(int intf, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_l3_ip_delete_by_prefix_async(bcm_ip_t ip_addr, bcm_ip_t mask, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_l3_ip_find_async(bcmx_l3_ip_t * info, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_l3_ip_find_index_async(int index, bcmx_l3_ip_t * info, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_l3_ip_update_entry_by_key_async(bcmx_l3_host_t * info, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_l3_status_async(int * free_l3intf, int * free_l3, int * free_defip, int * free_lpm_blk, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_l3_untagged_update_async(bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_l3_validate_entry_async(bcm_ip_t l3_addr, bcmx_async_cb_t async_callback, void *async_cookie);
#endif	/* INCLUDE_L3 */
...
void	bcmx_meter_create_async(bcmx_lport_t lport, int * mid, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_meter_delete_async(bcmx_lport_t lport, int mid, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_meter_delete_all_async(bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_meter_get_async(bcmx_lport_t lport, int mid, uint32 * kbits_sec, uint32 * kbits_burst, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_meter_init_async(bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_meter_set_async(bcmx_lport_t lport, int mid, uint32 kbits_sec, uint32 kbits_burst, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_mirror_pfmt_get_async(int * val, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_mirror_pfmt_set_async(int val, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_mirror_port_dest_add_async(bcmx_lport_t port, uint32 flags, bcm_gport_t mirror_dest, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_mirror_port_dest_delete_async(bcmx_lport_t port, uint32 flags, bcm_gport_t mirror_dest, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_mpls_info_async(bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_mpls_init_async(bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_mpls_l3_initiator_clear_async(bcm_l3_intf_t * intf, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_mpls_l3_initiator_clear_all_async(bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_mpls_l3_initiator_get_async(bcm_l3_intf_t * intf, bcm_mpls_l3_initiator_t * ftn, int * count, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_mpls_l3_initiator_set_async(bcm_l3_intf_t * intf, bcm_mpls_l3_initiator_t * ftn, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_mpls_port_block_get_async(bcm_vpn_t vpn, bcmx_lport_t lport, int * enable, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_mpls_port_block_set_async(bcm_vpn_t vpn, bcmx_lport_t lport, int enable, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_mpls_switch_add_async(bcmx_mpls_switch_t * mapping, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_mpls_switch_delete_async(bcmx_mpls_switch_t * mapping, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_mpls_switch_delete_all_async(int flag, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_mpls_switch_get_async(int max, bcmx_mpls_switch_t * mapping, int * count, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_mpls_vpn_add_async(bcm_vpn_t vpn, bcmx_mpls_vpn_t * vpn_info, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_mpls_vpn_circuit_add_async(bcm_vpn_t vpn, bcmx_mpls_circuit_t * vc_info, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_mpls_vpn_circuit_delete_async(bcm_vpn_t vpn, bcmx_mpls_circuit_t * vc_info, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_mpls_vpn_circuit_delete_all_async(bcm_vpn_t vpn, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_mpls_vpn_circuit_get_async(bcm_vpn_t vpn, int max, bcmx_mpls_circuit_t * vc_info, int * count, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_mpls_vpn_create_async(bcm_vpn_t vpn, uint32 flags, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_mpls_vpn_delete_async(bcm_vpn_t vpn, bcmx_mpls_vpn_t * vpn_info, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_mpls_vpn_delete_all_async(bcm_vpn_t vpn, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_mpls_vpn_destroy_async(bcm_vpn_t vpn, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_mpls_vpn_get_async(bcm_vpn_t vpn, int maxout, bcmx_mpls_vpn_t * vpn_info, int * count, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_port_ability_local_get_async(bcmx_lport_t port, bcmx_port_ability_t * ability_mask, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_port_class_get_async(bcmx_lport_t port, bcm_port_class_t pclass, uint32 * pclass_id, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_port_class_set_async(bcmx_lport_t port, bcm_port_class_t pclass, uint32 pclass_id, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_port_link_status_get_async(bcmx_lport_t port, int * up, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_port_tgid_get_async(bcmx_lport_t port, int * tid, int * psc, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_port_tgid_set_async(bcmx_lport_t port, int tid, int psc, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_vlan_ip4_add_async(bcm_ip_t ipaddr, bcm_ip_t netmask, bcm_vlan_t vid, int prio, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_vlan_ip4_delete_async(bcm_ip_t ipaddr, bcm_ip_t netmask, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_vlan_ip4_delete_all_async(bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_vlan_stp_get_async(bcm_vlan_t vid, bcmx_lport_t port, int * stp_state, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_vlan_stp_set_async(bcm_vlan_t vid, bcmx_lport_t port, int stp_state, bcmx_async_cb_t async_callback, void *async_cookie);
