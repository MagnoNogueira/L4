/*
 * $Id: loopback.h,v 1.10 Broadcom SDK $
...
typedef struct loopback_testdata_s {
    ...
    mac_addr_t	lp_mac_src;             /* SRC Mac address under test */
    uint32	lp_mac_src_inc;         /* Source mac increment */
    mac_addr_t	lp_mac_dst;             /* SRC Mac address under test */
...
typedef struct loopback_test_s {
    ...
    mac_addr_t	lw_mac_src;		/* Source MAC address under test */
    uint32	lw_mac_src_inc;		/* Source MAC increment */
    mac_addr_t	lw_mac_dst;		/* Dest MAC address under test */
    ...
    mac_addr_t	lw_cur_mac_src;		/* SRC Mac address under test */
    mac_addr_t	lw_cur_mac_dst;		/* SRC Mac address under test */
