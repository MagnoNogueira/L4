/*
 * $Id: loopback2.h,v 1.10.4.2 Broadcom SDK $
...
#define LBD_SEND_LLIST  2            /* Note Yet Supported */
    ...
    mac_addr_t  mac_src;             /* SRC Mac address under test */
    uint32      mac_src_inc;         /* Source mac increment */
    mac_addr_t  mac_dst;             /* SRC Mac address under test */
...
typedef struct loopback2_test_s {
    ...
    mac_addr_t  base_mac_src;        /* Source MAC address base for loop */
    mac_addr_t  base_mac_dst;        /* Dest MAC address base for loop */
