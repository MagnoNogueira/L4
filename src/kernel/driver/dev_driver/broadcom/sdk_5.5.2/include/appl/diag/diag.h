/*
 * $Id: diag.h,v 1.4.6.1 Broadcom SDK $
...
extern void disp_port_info(char *port_ref, bcm_port_info_t *info, 
                           bcm_port_ability_t *local, bcm_port_ability_t *remote, 
                           bcm_port_ability_t *advert, int st_port, uint32 flags);
...
extern int port_parse_port_ability_set(uint32 flags, bcm_port_info_t *src, 
                                       bcm_port_ability_t *dest);
