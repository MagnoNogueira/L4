/*
 * $Id: cputrans.h,v 1.14 Broadcom SDK $
...
#if 0 /* Here's a sample TX reserve setup */
 ...
 *     CPUTRANS_COS_MASK           (3 bits).  See below.
 *     CPUTRANS_COS_OVERRIDE       Use the priority bits specified in above
 *                                 field as the priority for a transmit.
...
#define CPUTRANS_NO_HEADER_ALLOC    0x1    
#define CPUTRANS_BCAST              0x2    /* Implies BET and next hop */
#define CPUTRANS_LOOPBACK           0x10
#define CPUTRANS_NO_L2_UPDATE       0x20
#define CPUTRANS_NO_ACK             0x40
#define CPUTRANS_NEXT_HOP           0x80
#define CPUTRANS_COS_SHIFT          8
#define CPUTRANS_COS_MASK           (0x7 << CPUTRANS_COS_SHIFT)
#define CPUTRANS_COS_OVERRIDE       0x800
#define CPUTRANS_CRC_REGEN          0x1000
#define CPUTRANS_IMMEDIATE_ACK      0x2000

/* Assert:  0 <= val < 8 */
#define CPUTRANS_COS_SET(flags, val)                          \
   (flags) = (((flags) & (~CPUTRANS_COS_MASK)) |              \
       ((val) << CPUTRANS_COS_SHIFT) | CPUTRANS_COS_OVERRIDE)
