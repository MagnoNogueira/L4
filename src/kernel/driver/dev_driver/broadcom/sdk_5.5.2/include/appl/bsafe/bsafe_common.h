 ...
 * $Id: bsafe_common.h,v 1.4 Broadcom SDK $
 */
...
/* include vers.h */
#include <appl/bsafe/bsafe_vers.h>

/* returnstatus returned by the chip */
#include <appl/bsafe/bsafe_returncode.h>

/* status returned by driver */
#include <appl/bsafe/bsafe_status.h>
...
#define BSAFE_FIPS_CLR_VECTOR     0xFA1E4907
 ...
 * where it is ordered in memory by words as LSW........MSW  where each word
 * is in bigendian. ie words are BE and the array of words is in LE.
 *
 * In other words the BSAFE_BIGNUM is an array of 32 bit integers[Words]
 * ordered from Least-Significant-Word to Most-Signifcant-Word, where each
 * Word is ordered as Most-Signifcant byte to Least-Significant byte.
 * eg:
    Array Index
    a            0   1   2   3   4   5   6   7 
            MSB                          LSB
