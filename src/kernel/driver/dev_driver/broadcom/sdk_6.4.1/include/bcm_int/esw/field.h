/*
 * $Id: field.h,v 1.407 Broadcom SDK $
...
typedef enum _bcm_field_slice_sel_e {
    ...
    _bcmFieldSliceSelEgrDvpKey4,      /* Secondary Selector EFP_KEY4_DVP_SELECTORr */ 
    _bcmFieldSliceSelEgrMdlKey4,      /* Secondary Selector EFP_KEY4_MDL_SELECTORr */ 
...
extern int _field_meter_pool_free(int unit,
                _field_stage_t *stage_fc, uint8 pool_idx);
