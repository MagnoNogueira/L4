 ...
 *      txAmpAdj    - Transmitter Amplitude Adjust(valid values range 0-3).
 ...
 *      2. Relevant fields for xCat and above: txAmp, txEmphAmp, txAmpAdj,
...
*       is TRUE the switch MAC will be configured
*
*       2. Although for XGMII (10 Gbps) ports feature is not supported we let
...
*
* COMMENTS:
*       Not supported for CPU port of DX devices.
