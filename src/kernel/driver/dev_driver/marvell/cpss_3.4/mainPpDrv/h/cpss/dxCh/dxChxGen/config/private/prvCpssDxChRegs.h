...
struct _perPortRegs
{
    ...
    GT_U32 macCtrl4;            /* MAC Control Register4 XCAT2 new */
};
...
typedef struct
{
    ...
    struct _pcl
    {
       ...
       /* CNC relted registers */
        ...
        GT_U32 configTblParityErrCtr[2]; /* Config Table Parity Error Counter per PclConfigTable */

        struct _macToMe
        {
            GT_U32  macLow; /* for now to save place I add just this register, other could be added 
                               when needed */
        }macToMe[8];
    ...
    struct{
        ...
        GT_U32 preEgressToTxq0;        
        GT_U32 preEgressToTxq1;        
