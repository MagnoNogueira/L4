 ...
 *
 * Fields:
 *      CPSS_CSCD_PORT_DSA_MODE_REGULAR_E - port used for cascading using
 *                                   regular DSA tag. relevant to DxSal,DxCh
 *                                   devices.
 *      CPSS_CSCD_PORT_DSA_MODE_EXTEND_E - port used for cascading using
 *                                   extended DSA tag. relevant to DxCh devices.
 *      CPSS_CSCD_PORT_NETWORK_E   - regular network port. port not used for
 *                                   cascading and not using DSA tag.
 *                                   relevant to DxSal,DxCh devices.
 *
 */
typedef enum
{
