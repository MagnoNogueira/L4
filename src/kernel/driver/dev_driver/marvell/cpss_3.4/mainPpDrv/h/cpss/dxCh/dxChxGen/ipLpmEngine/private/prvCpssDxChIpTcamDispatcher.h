...
#ifndef __prvCpssDxChIpTcamDispatcher
#define __prvCpssDxChIpTcamDispatcher
...
#define NON_INITIALIZED_TOKEN_CNS 0xFFFFFFFF

/*
 * Typedef: enum PRV_CPSS_DXCH_DISPATCHER_TCAM_RULE_UPDATE_ENT
 *
 * Description: define  update tcam rule cases
 *
 * Enumerations:
 *    PRV_CPSS_DXCH_DISPATCHER_TCAM_RULE_UPDATE_TRIE_E               - update trie node of given rule
 *    PRV_CPSS_DXCH_DISPATCHER_TCAM_ALLOCATED_RULE_UPDATE_E          - update rule by new allocated rule.
 *    PRV_CPSS_DXCH_DISPATCHER_TCAM_ALLOCATED_RULE_AND_TRIE_UPDATE_E - update rule by new allocated rule
 *                                                                     and update its trie node.
 *    PRV_CPSS_DXCH_DISPATCHER_TCAM_RULE_COPY_E                      - copy rule from one trie node to another.
 *    PRV_CPSS_DXCH_DISPATCHER_TCAM_INVALID_RULE_E                   - invalid rule node.
 *    PRV_CPSS_DXCH_DISPATCHER_TCAM_INVALID_OLD_RULE_E               - invalid legacy rule node only.
 *    PRV_CPSS_DXCH_DISPATCHER_TCAM_INIT_TOKEN_RULE_INFO_E           - invalid token rule node only.
 *    PRV_CPSS_DXCH_DISPATCHER_TCAM_INIT_RULE_INFO_E                 - initilize rule parameters.
 *    PRV_CPSS_DXCH_DISPATCHER_TCAM_CHECK_RULE_VALIDITY_E            - check rule validity.
 *
 * Comment:
 *      None.
 */
typedef enum
{
    PRV_CPSS_DXCH_DISPATCHER_TCAM_RULE_UPDATE_TRIE_E,
    PRV_CPSS_DXCH_DISPATCHER_TCAM_ALLOCATED_RULE_UPDATE_E,
    PRV_CPSS_DXCH_DISPATCHER_TCAM_ALLOCATED_RULE_AND_TRIE_UPDATE_E,
    PRV_CPSS_DXCH_DISPATCHER_TCAM_RULE_COPY_E,
    PRV_CPSS_DXCH_DISPATCHER_TCAM_INVALID_RULE_E,
    PRV_CPSS_DXCH_DISPATCHER_TCAM_INVALID_OLD_RULE_E,
    PRV_CPSS_DXCH_DISPATCHER_TCAM_INIT_TOKEN_RULE_INFO_E,
    PRV_CPSS_DXCH_DISPATCHER_TCAM_INIT_RULE_INFO_E,
    PRV_CPSS_DXCH_DISPATCHER_TCAM_CHECK_RULE_VALIDITY_E
} PRV_CPSS_DXCH_DISPATCHER_TCAM_RULE_UPDATE_ENT;



#define PRV_CPSS_DXCH_SET_BOUNDING_SON_MAC(tcamManagementMode,trieNodePtr,boundingSonTrieNodePtr)       \
        if((tcamManagementMode) == PRV_CPSS_DXCH_IP_TCAM_MANAGEMENT_TCAM_ENTRIES_HANDLER_MODE_E)        \
...
#define  PRV_CPSS_DXCH_ALLOCATE_TOKEN_NODE_MAC(tcamManagementMode,trieNodePtr)\
        if((tcamManagementMode) == PRV_CPSS_DXCH_IP_TCAM_MANAGEMENT_TCAM_MANAGER_MODE_E)\
          {\
           (trieNodePtr)->tcamAllocInfo.tokenNode = (PRV_CPSS_DXCH_IP_TCAM_TOKEN_NODE_STC *)cpssOsMalloc(\
                                                    sizeof(PRV_CPSS_DXCH_IP_TCAM_TOKEN_NODE_STC));\
...
#define  PRV_CPSS_DXCH_FREE_TOKEN_NODE_MAC(tcamManagementMode,trieNodePtr)\
        if((tcamManagementMode) == PRV_CPSS_DXCH_IP_TCAM_MANAGEMENT_TCAM_MANAGER_MODE_E)\
          {\
           if((trieNodePtr)->tcamAllocInfo.tokenNode != NULL)\
...
#define  PRV_CPSS_DXCH_FREE_TOKEN_NODE_FOR_VALID_TRIE_MAC(tcamManagementMode,trieNodePtr)\
        if((tcamManagementMode) == PRV_CPSS_DXCH_IP_TCAM_MANAGEMENT_TCAM_MANAGER_MODE_E)\
          {\
          if(trieNodePtr->tcamAllocInfo.tokenNode != NULL)\
...
#define  PRV_CPSS_DXCH_FREE_ROOT_TOKEN_NODE_MAC(tcamManagementMode,trieNodePtr)\
        if((tcamManagementMode) == PRV_CPSS_DXCH_IP_TCAM_MANAGEMENT_TCAM_MANAGER_MODE_E)\
          {\
           if(trieNodePtr->tcamAllocInfo.tokenNode != NULL)\
               cpssOsFree(trieNodePtr->tcamAllocInfo.tokenNode);\
...
/*******************************************************************************
* prvCpssDxChIpTcamDispatcherRuleInfoUpdate
*
* DESCRIPTION:
...
*
*******************************************************************************/
 GT_STATUS prvCpssDxChIpTcamDispatcherRuleInfoUpdate
(
    IN  PRV_CPSS_DXCH_DISPATCHER_TCAM_RULE_UPDATE_ENT ruleUpdateAction,
    IN  PRV_CPSS_DXCH_IP_TCAM_MANAGEMENT_MODE_ENT     tcamManagementMode,
    IN  PRV_CPSS_DXCH_IP_PAT_TRIE_NODE_STC            *srcTrieNodePtr,
    IN  PRV_CPSS_DXCH_IP_PAT_TRIE_NODE_STC            *dstTrieNodePtr,
    IN  GT_PTR                                        allocatedRulePtr
);


/*******************************************************************************
* prvCpssDxChIpTcamDispatcherRuleSet
*
* DESCRIPTION:
*       Set TCAM allocate rule
*
...
*
*******************************************************************************/
 GT_STATUS prvCpssDxChIpTcamDispatcherRuleSet
(
...
/*******************************************************************************
* prvCpssDxChIpTcamDispatchAllocate
*
* DESCRIPTION:
...
*
*******************************************************************************/
GT_STATUS prvCpssDxChIpTcamDispatchAllocate
(
    IN  PRV_CPSS_DXCH_IP_TCAM_SHADOW_STC                    *ipTcamShadowPtr,
    IN  PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_ENTRY_TYPE_ENT   entryType,
    IN  GT_PTR                                              lowerBound,
    IN  GT_PTR                                              upperBound,
    IN  PRV_CPSS_DXCH_IP_TCAM_MGM_ALLOC_METHOD_ENT          tcamHandlerAllocMethod,
...
*
*******************************************************************************/
GT_STATUS prvCpssDxChIpTcamDispatchFree
(
    IN  PRV_CPSS_DXCH_IP_TCAM_SHADOW_STC                   *ipTcamShadowPtr,
    IN  PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_ENTRY_TYPE_ENT  entryType,
    IN  PRV_CPSS_DXCH_IP_PAT_TRIE_NODE_STC                 *trieNodePtr
...
/*******************************************************************************
* prvCpssDxChIpTcamDispatcherCompRulesPos
*
* DESCRIPTION:
...
*
*******************************************************************************/
GT_STATUS prvCpssDxChIpTcamDispatcherCompRulesPos
(
    IN  PRV_CPSS_DXCH_IP_TCAM_SHADOW_STC                     *ipTcamShadowPtr,
...
/*******************************************************************************
* prvCpssDxChIpTcamDispatchCheckAvailbleMem
*
* DESCRIPTION:
*       compares two rules in terms of position.
*
...
*
*******************************************************************************/
GT_STATUS prvCpssDxChIpTcamDispatchCheckAvailbleMem
(
    IN  PRV_CPSS_DXCH_IP_TCAM_SHADOW_STC                     *ipTcamShadowPtr,
    IN  PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_ENTRY_TYPE_ENT     entryType,
...
/*******************************************************************************
* prvCpssDxChIpTcamDispatchGetEntryHsuInfo
*
* DESCRIPTION:
...
*
*******************************************************************************/
GT_STATUS prvCpssDxChIpTcamDispatchGetEntryHsuInfo
(
    IN  PRV_CPSS_DXCH_IP_TCAM_SHADOW_STC                    *ipTcamShadowPtr,
    IN  PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_ENTRY_TYPE_ENT   entryType,
    IN  PRV_CPSS_DXCH_IP_PAT_TRIE_NODE_STC                  *trieNodePtr,
...
/*******************************************************************************
* prvCpssDxChIpTcamDispatchSetEntryHsuInfo
*
* DESCRIPTION:
...
*
*******************************************************************************/
GT_STATUS prvCpssDxChIpTcamDispatchSetEntryHsuInfo
(
    IN  PRV_CPSS_DXCH_IP_TCAM_SHADOW_STC                    *ipTcamShadowPtr,
    IN  PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_ENTRY_TYPE_ENT   entryType,
    IN  GT_U32                                              hsuInfo,
...
#endif /* __prvCpssDxChIpTcamDispatcher */
