...
struct PRV_CPSS_DXCH_IP_TCAM_SHADOW_STCT;
...
/*
 * typedef: enum PRV_CPSS_DXCH_IP_TCAM_MANAGEMENT_MODE_ENT
 *
 * Description:
 *      TCAM management mode
 *
 * Enumerations:
 *      PRV_CPSS_DXCH_IP_TCAM_MANAGEMENT_TCAM_ENTRIES_HANDLER_MODE_E - in this
 *                      mode TCAM management is done by TCAM Entries Handler.
 *      PRV_CPSS_DXCH_IP_TCAM_MANAGEMENT_TCAM_MANAGER_MODE_E - in this
...
typedef enum
{
    PRV_CPSS_DXCH_IP_TCAM_MANAGEMENT_TCAM_ENTRIES_HANDLER_MODE_E,
    PRV_CPSS_DXCH_IP_TCAM_MANAGEMENT_TCAM_MANAGER_MODE_E
}PRV_CPSS_DXCH_IP_TCAM_MANAGEMENT_MODE_ENT;
...
typedef struct PRV_CPSS_DXCH_IP_PAT_TRIE_NODE_STCT
{
   ...
   union
   {
       ...
       struct PRV_CPSS_DXCH_IP_TCAM_TOKEN_NODE_STCT     *tokenNode;
   }
   tcamAllocInfo;
   GT_PTR                                               pData;
   GT_U32                                               vrId;
   ...
   struct PRV_CPSS_DXCH_IP_TCAM_SHADOW_STCT             *ipTcamShadowPtr;
...
(
    IN struct PRV_CPSS_DXCH_IP_TCAM_SHADOW_STCT      *ipTcamShadowPtr,
    IN GT_U32                                         vrId,
    IN GT_U8                                          *ipAddr,
    IN GT_U32                                         prefixLen,
...
/*******************************************************************************
* cpssDxChIpPatTrieGetBoundingSon
*
* DESCRIPTION:
...
*
*******************************************************************************/
GT_STATUS cpssDxChIpPatTrieGetBoundingSon
(
    IN  PRV_CPSS_DXCH_IP_PAT_TRIE_NODE_STC          *trieNodePtr,
    IN  struct PRV_CPSS_DXCH_IP_TCAM_SHADOW_STCT    *ipTcamShadowPtr,
    OUT PRV_CPSS_DXCH_IP_PAT_TRIE_NODE_STC          **boundingSonTrieNodePtrPtr
);
...
/*******************************************************************************
* cpssDxChIpPatTrieGetNextPostOrderTrieNode
*
* DESCRIPTION:
...
*              {
*                  prvCpssDxChIpPatTrieGetNextPostOrderTrieNode(&nodePtr,&isLastNode);
*                  process node...
*              }
*******************************************************************************/
GT_STATUS cpssDxChIpPatTrieGetNextPostOrderTrieNode
(
    INOUT PRV_CPSS_DXCH_IP_PAT_TRIE_NODE_STC    **nodePtrPtr,
