...
********************************************************************************
* prvCpssDxChIpTcamEntriesHandler.h
*
* DESCRIPTION:
...
#ifndef __prvCpssDxChIpTcamEntriesHandlerh
#define __prvCpssDxChIpTcamEntriesHandlerh
...
/*******************************************************************************
* prvCpssDxChTcamEntriesHandlerCreate
*
* DESCRIPTION:
...
*
*******************************************************************************/
GT_STATUS prvCpssDxChTcamEntriesHandlerCreate
(
    INOUT PRV_CPSS_DXCH_IP_TCAM_SHADOW_STC              *ipTcamShadowPtr,
...
/*******************************************************************************
* prvCpssDxChTcamEntriesHandlerDelete
*
* DESCRIPTION:
...
*
*******************************************************************************/
GT_STATUS prvCpssDxChTcamEntriesHandlerDelete
(
    INOUT PRV_CPSS_DXCH_IP_TCAM_SHADOW_STC              *ipTcamShadowPtr
);

/*******************************************************************************
* ipTcamMemPoolCheetah2PolicyBasedRoutingInit
*
* DESCRIPTION:
...
*
*******************************************************************************/
GT_STATUS ipTcamMemPoolCheetah2PolicyBasedRoutingInit
(
...
/*******************************************************************************
* prvCpssDxChTcamEntriesHandlerAllocate
*
* DESCRIPTION:
...
*
*******************************************************************************/
GT_STATUS prvCpssDxChTcamEntriesHandlerAllocate
(
    IN PRV_CPSS_DXCH_IP_TCAM_SHADOW_STC                     *ipTcamShadowPtr,
    ...
    IN  PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_ALLOC_METHOD_ENT allocMethod,
    IN  GT_BOOL                                             defragEnable,
    OUT PRV_CPSS_DXCH_IP_TCAM_RULE_NODE_STC                 **allocNodePtrPtr
);

/*******************************************************************************
* prvCpssDxChTcamEntriesHandlerAllocByGivenRule
*
* DESCRIPTION:
...
*
*******************************************************************************/
GT_STATUS prvCpssDxChTcamEntriesHandlerAllocByGivenRule
(
...
/*******************************************************************************
* prvCpssDxChTcamEntriesHandlerFree
*
* DESCRIPTION:
*       Frees a TCAM entry.
*
...
*
*******************************************************************************/
GT_STATUS prvCpssDxChTcamEntriesHandlerFree
(
    IN  PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_STC              *tcamHandlerPtr,
    IN  PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_ENTRY_TYPE_ENT   entryType,
...
/*******************************************************************************
* prvCpssDxChTcamEntriesHandlerCheckAvailbleMem
*
* DESCRIPTION:
...
*
*******************************************************************************/
GT_STATUS prvCpssDxChTcamEntriesHandlerCheckAvailbleMem
(
    IN  PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_STC              *tcamHandlerPtr,
    IN  PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_ENTRY_TYPE_ENT   entryType,
...
/*******************************************************************************
* prvCpssDxChTcamEntriesHandlerGetRuleIdx
*
* DESCRIPTION:
...
*
*******************************************************************************/
GT_STATUS prvCpssDxChTcamEntriesHandlerGetRuleIdx
(
    IN  PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_STC              *tcamHandlerPtr,
    IN  PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_ENTRY_TYPE_ENT   entryType,
    IN  PRV_CPSS_DXCH_IP_TCAM_RULE_NODE_STC                 *allocNodePtr,
...
/*******************************************************************************
* prvCpssDxChTcamEntriesHandlerGetRuleByRuleIdx
*
* DESCRIPTION:
*       The TCAM entries handler maintains internal array that holds rules (those
*       rules are also associated with the prefixes attached to them).
...
*
*******************************************************************************/
GT_STATUS prvCpssDxChTcamEntriesHandlerGetRuleByRuleIdx
(
    IN  PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_STC              *tcamHandlerPtr,
    IN  PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_ENTRY_TYPE_ENT   entryType,
    IN  GT_32                                               ruleIdx,
...
/*******************************************************************************
* prvCpssDxChTcamEntriesHandlerSetRealIdxAsAlloc
*
* DESCRIPTION:
...
*
*******************************************************************************/
GT_STATUS prvCpssDxChTcamEntriesHandlerSetRealIdxAsAlloc
(
    IN  PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_STC              *tcamHandlerPtr,
    IN  PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_ENTRY_TYPE_ENT   entryType,
    IN  GT_U32                                              hwIndex,
...
/*******************************************************************************
* prvCpssDxChTcamEntriesHandlerGetRuleInfoByRealIdx
*
* DESCRIPTION:
*       The TCAM entries handler maintains internal array that holds rules (those
*       rules are also associated with the prefixes attached to them).
...
*
*******************************************************************************/
GT_STATUS prvCpssDxChTcamEntriesHandlerGetRuleInfoByRealIdx
(
    IN    PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_STC            *tcamHandlerPtr,
    IN    GT_U32                                            hwIndex,
    INOUT PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_ENTRY_TYPE_ENT *entryTypePtr,
    OUT   PRV_CPSS_DXCH_IP_TCAM_RULE_NODE_STC               **ruleNodePtrPtr
);
...
#endif /* __prvCpssDxChIpTcamEntriesHandlerh */
