...
********************************************************************************
* prvCpssDxChIpTcamEntriesHandlerTypes.h
*
* DESCRIPTION:
...
#ifndef __prvCpssDxChIpTcamEntriesHandlerTypesh
#define __prvCpssDxChIpTcamEntriesHandlerTypesh
...
/*
 * typedef: enum PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_ENTRY_TYPE_ENT
 *
 * Description:
 *      TCAM entry type.
 *
 * Enumerations:
 *      PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_IPV4_UC_ENTRY_E        - IPv4 UC
 *      PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_IPV4_MC_GROUP_ENTRY_E  - IPv4 MC group
 *      PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_IPV4_MC_SOURCE_ENTRY_E - IPv4 MC source
 *      PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_IPV6_UC_ENTRY_E        - IPv6 UC
 *      PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_IPV6_MC_GROUP_ENTRY_E  - IPv6 MC group
 *      PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_IPV6_MC_SOURCE_ENTRY_E - IPv6 MC source
 *      PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_NON_IP_ENTRY_E         - entry using router tcam
...
typedef enum
{
    PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_IPV4_UC_ENTRY_E,
    PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_IPV4_MC_GROUP_ENTRY_E,
    PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_IPV4_MC_SOURCE_ENTRY_E,
    PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_IPV6_UC_ENTRY_E,
    PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_IPV6_MC_GROUP_ENTRY_E,
    PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_IPV6_MC_SOURCE_ENTRY_E,
    PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_NON_IP_ENTRY_E

}PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_ENTRY_TYPE_ENT;

/*
 * typedef: enum PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_ALLOC_METHOD_ENT
 *
 * Description:
 *      TCAM entries handler index allocation method.
 *
 * Enumerations:
 *      PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_ALLOC_MIN_E    - allocate minimal index.
 *      PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_ALLOC_MID_E    - allocate near middle index.
 *      PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_ALLOC_MAX_E    - allocate maximal index.
 *
 * Comments:
 *
 */
typedef enum
{
    PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_ALLOC_MIN_E,
    PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_ALLOC_MID_E,
    PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_ALLOC_MAX_E

}PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_ALLOC_METHOD_ENT;


/*
 * typedef: enum PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_MODE_ENT
 *
 * Description:
 *      Operation mode of the TCAM entries handler
 *
 * Enumerations:
 *      PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_PARTITION_MODE_E - LPM DB TCAM is
 *                  partitioned so each entry type has fixed section of the TCAM
 *      PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_NO_PARTITION_MODE_E  - LPM DB TCAM
 ...
 *      PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_INVALID_MODE_E - invalid
 *
 * Comments:
 *
 */
typedef enum
{
    PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_PARTITION_MODE_E,
    PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_NO_PARTITION_MODE_E,
    PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_INVALID_MODE_E

}PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_MODE_ENT;

/*
 * typedef: enum PRV_CPSS_DXCH_TCAM_SEARCH_ORDER_ENT
 *
 * Description:
 *      Search order of the router/TTI TCAM.
 *
 * Enumerations:
 *      PRV_CPSS_DXCH_TCAM_COLUMN_SEARCH_ORDER_E - column search order;
 *                       meaning entries in first column,
 *                       then entries in second column etc...
 *      PRV_CPSS_DXCH_TCAM_ROW_SEARCH_ORDER_E - row search column;
...
typedef enum
{
    PRV_CPSS_DXCH_TCAM_COLUMN_SEARCH_ORDER_E,
    PRV_CPSS_DXCH_TCAM_ROW_SEARCH_ORDER_E

}PRV_CPSS_DXCH_TCAM_SEARCH_ORDER_ENT;

/*
 * typedef: struct PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_STC
 *
 * Description:
...
typedef struct
{
    PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_MODE_ENT     operationMode;

    PRV_CPSS_DXCH_IP_TCAM_MGM_MULTIPLE_POOLS_STC    ipTcamPool;
    PRV_CPSS_DXCH_IP_TCAM_MGM_POOL_STC              *ipMcSrcTcamPool;
    CPSS_DXCH_IP_TCAM_SHADOW_TYPE_ENT               tcamShadowType;

    PRV_CPSS_DXCH_IP_TCAM_RULE_NODE_STC             *prefixPtrArray;
    GT_U32                                          *entriesUsagePtr;
    GT_U32                                          *lineUsagePtr;
    GT_U32                                          firstTcamLine;
    GT_U32                                          numOfTcamLines;
    GT_U32                                          numOfTcamEntries;
    PRV_CPSS_DXCH_TCAM_SEARCH_ORDER_ENT             tcamSearchOrder;
...
}PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_STC;
...
#endif /* __prvCpssDxChIpTcamEntriesHandlerTypesh */
