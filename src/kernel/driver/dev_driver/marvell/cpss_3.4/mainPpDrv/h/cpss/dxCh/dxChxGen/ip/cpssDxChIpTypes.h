 ...
 *                      check (APPLICABLE DEVICES: DxCh3; xCat; Lion; xCat2)
 */
...
/*
 * typedef: enum CPSS_DXCH_IP_MLL_PAIR_WRITE_FORM_ENT
 *
 * Description: the possible forms to write the MLL Pair entry.
 *
 * Enumerations:
 *
 *  CPSS_DXCH_IP_MLL_PAIR_READ_WRITE_FIRST_MLL_ONLY_E   - reads/writes just the
 *                                                        first mll of the pair.
 *  CPSS_DXCH_IP_MLL_PAIR_READ_WRITE_SECOND_MLL_NEXT_POINTER_ONLY_E - reads/writes
 *                         just the second Mll of the pair and the next pointer.
 *  CPSS_DXCH_IP_MLL_PAIR_READ_WRITE_WHOLE_E  - reads/writes the whole mll pair.
 */
typedef enum
{
    CPSS_DXCH_IP_MLL_PAIR_READ_WRITE_FIRST_MLL_ONLY_E                = 0,
    CPSS_DXCH_IP_MLL_PAIR_READ_WRITE_SECOND_MLL_NEXT_POINTER_ONLY_E  = 1,
    CPSS_DXCH_IP_MLL_PAIR_READ_WRITE_WHOLE_E                         = 2
}CPSS_DXCH_IP_MLL_PAIR_READ_WRITE_FORM_ENT;
...
/*
 * typedef: enum CPSS_DXCH_IP_VLAN_URPF_MODE_ENT
 *
 * Description: Defines the uRPF check modes
 *
 * Enumerations:
 *  CPSS_DXCH_IP_VLAN_URPF_DISABLE_MODE_E  - uRPF check is disabled
 *
 *  CPSS_DXCH_IP_VLAN_URPF_VLAN_MODE_E  - If ECMP uRPF is globally enabled,
 ...
 *  CPSS_DXCH_IP_VLAN_URPF_PORT_TRUNK_MODE_E  - uRPF check is done by comparing the
...
typedef enum
{
   CPSS_DXCH_IP_VLAN_URPF_DISABLE_MODE_E     = 0,
   CPSS_DXCH_IP_VLAN_URPF_VLAN_MODE_E        = 1,
   CPSS_DXCH_IP_VLAN_URPF_PORT_TRUNK_MODE_E  = 2

}CPSS_DXCH_IP_VLAN_URPF_MODE_ENT;
