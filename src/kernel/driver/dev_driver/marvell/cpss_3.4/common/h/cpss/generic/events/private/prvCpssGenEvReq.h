...
STR(CPSS_PP_GTS_VALID_TIME_SAMPLE_MESSAGE _E),  /* 342 */                       \
                                                                                \
                                                                                \
                                                                                \
                                                                                \
    ...
    /************************** Xbar events ********************************/   \
                                                                                \
                                                                                \
STR(CPSS_XBAR_HG_LANE_SYNCH_CHANGE_E),   /* 343 */                              \
STR(CPSS_XBAR_HG_LANE_COMMA_ALIGN_CHANGE_E),   /* 344 */                        \
STR(CPSS_XBAR_GPORT_INVALID_TRG_DROP_CNT_INC_E),   /* 345 */                    \
STR(CPSS_XBAR_GPORT_DIAG_CELL_RX_CNTR_INC_E),   /* 346 */                       \
STR(CPSS_XBAR_MISC_E),   /* 347 */                                              \
STR(CPSS_XBAR_HG_PING_RECEIVED_E),   /* 348 */                                  \
STR(CPSS_XBAR_HOST_RX_FIFO_PEND_E),   /* 349 */                                 \
STR(CPSS_XBAR_HOST_SEND_CELL_E),   /* 350 */                                    \
STR(CPSS_XBAR_HG_ALIGNMENT_LOCK_CHANGE_E),   /* 351 */                          \
STR(CPSS_XBAR_HG_PING_E),   /* 352 */                                           \
STR(CPSS_XBAR_SD_INV_ADDR_E),   /* 353 */                                       \
STR(CPSS_XBAR_SXBAR_INV_ADDR_E),   /* 354 */                                    \
STR(CPSS_XBAR_S_INV_ADDR_E),   /* 355 */                                        \
STR(CPSS_XBAR_G_INV_ADDR_E),   /* 356 */                                        \
STR(CPSS_XBAR_MC_INV_ADDR_E),   /* 357 */                                       \
                                                                                \
                                                                                \
                                                                                \
                                                                                \
    ...
    /************************** Fa events **********************************/   \
                                                                                \
                                                                                \
STR(CPSS_FA_UC_PRIO_BUF_FULL_E),   /* 358 */                                    \
STR(CPSS_FA_MC_PRIO_BUF_FULL_E),   /* 359 */                                    \
STR(CPSS_FA_UC_RX_BUF_FULL_E),   /* 360 */                                      \
STR(CPSS_FA_MC_RX_BUF_FULL_E),   /* 361 */                                      \
STR(CPSS_FA_WD_FPORT_GRP_E),   /* 362 */                                        \
STR(CPSS_FA_MC_WD_EXP_E),   /* 363 */                                           \
STR(CPSS_FA_GLBL_DESC_FULL_E),   /* 364 */                                      \
STR(CPSS_FA_MAC_UPD_THRS_E),   /* 365 */                                        \
STR(CPSS_FA_DROP_DEV_EN_E),   /* 366 */                                         \
STR(CPSS_FA_MISC_I2C_TIMEOUT_E),   /* 367 */                                    \
STR(CPSS_FA_MISC_STATUS_E),   /* 368 */                                         \
                                                                                \
                                                                                \
                                                                                \
                                                                                \
    ...
    /************************** DRAGONITE events ***************************/   \
                                                                                \
                                                                                \
STR(CPSS_DRAGONITE_PORT_ON_E),  /* 369 */                                       \
STR(CPSS_DRAGONITE_PORT_OFF_E),  /* 370 */                                      \
STR(CPSS_DRAGONITE_DETECT_FAIL_E),  /* 371 */                                   \
STR(CPSS_DRAGONITE_PORT_FAULT_E),  /* 372 */                                    \
STR(CPSS_DRAGONITE_PORT_UDL_E),  /* 373 */                                      \
STR(CPSS_DRAGONITE_PORT_FAULT_ON_STARTUP_E),  /* 374 */                         \
STR(CPSS_DRAGONITE_PORT_PM_E),  /* 375 */                                       \
STR(CPSS_DRAGONITE_POWER_DENIED_E),  /* 376 */                                  \
STR(CPSS_DRAGONITE_OVER_TEMP_E),  /* 377 */                                     \
STR(CPSS_DRAGONITE_TEMP_ALARM_E),  /* 378 */                                    \
STR(CPSS_DRAGONITE_DEVICE_FAULT_E),  /* 379 */                                  \
STR(CPSS_DRAGONITE_OVER_CONSUM_E),  /* 380 */                                   \
STR(CPSS_DRAGONITE_VMAIN_LOW_AF_E),  /* 381 */                                  \
STR(CPSS_DRAGONITE_VMAIN_LOW_AT_E),  /* 382 */                                  \
STR(CPSS_DRAGONITE_VMAIN_HIGH_E),  /* 383 */                                    \
STR(CPSS_DRAGONITE_READ_EVENT_E),  /* 384 */                                    \
STR(CPSS_DRAGONITE_WRITE_EVENT_E),  /* 385 */                                   \
STR(CPSS_DRAGONITE_ERROR_E)  /* 386 */
