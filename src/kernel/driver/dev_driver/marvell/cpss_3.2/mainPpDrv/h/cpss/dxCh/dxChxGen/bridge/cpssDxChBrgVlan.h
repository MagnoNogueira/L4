 ...
 *                            supported for DxCh3 and above devices
 *      floodVidx           - The multicast group to which the flooded packet
 *                            is to be transmitted.
 *                            supported for DxChXcat and above devices
...
*                         The parameter is relevant only for DxChXcat and above
