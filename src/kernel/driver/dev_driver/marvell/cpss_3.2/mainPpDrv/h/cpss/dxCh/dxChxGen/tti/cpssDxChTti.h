...
*                           CPSS_DXCH_TTI_KEY_MIM_E (DxChXcat and above)
...
*
* COMMENTS:
*   In xCat and above we have 2 registers used for ethertype configuration.
...
*                               CPSS_PACKET_CMD_DROP_HARD_E
*
*       CPSS_DXCH_TTI_EXCEPTION_MPLS_ILLEGAL_TTL_ERROR_E - (DxChXcat and above)
*                               CPSS_PACKET_CMD_TRAP_TO_CPU_E
*                               CPSS_PACKET_CMD_DROP_HARD_E
*
*       CPSS_DXCH_TTI_EXCEPTION_MPLS_UNSUPPORTED_ERROR_E - (DxChXcat and above)
*                               CPSS_PACKET_CMD_TRAP_TO_CPU_E
*                               CPSS_PACKET_CMD_DROP_HARD_E
*
*
