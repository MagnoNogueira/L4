 ...
 *   CPSS_98DX3011_CNS       = 0xDE6011AB,              0        16        2        0        0        0
...
#define    CPSS_98DX3011_CNS        0xDE6011AB    /*    0        16        2        0        0        0   */
...
#define    CPSS_98CX8203_CNS    0xE01111AB    /* 24 ports , RXAUI, pipes 0,3 */
...
#define    CPSS_98CX8265_CNS    0xE05311AB    /*  48 port RXAUI        */
#define    CPSS_98CX8266_CNS    0xE04111AB    /*  24 port XAUI         */
...
#define CPSS_LION_PORT_GROUPS_0123_DEVICES_CASES_MAC  \
    ...
    case CPSS_98CX8266_CNS/*caller end with ':' */

/* lion devices with port groups 0,3 */
#define    CPSS_LION_PORT_GROUPS_0__3_CNS \
    CPSS_98CX8203_CNS

/* lion devices with port groups 0,3 -- for switch-case*/
#define CPSS_LION_PORT_GROUPS_0__3_DEVICES_CASES_MAC  \
    /*caller start with 'case' */                     \
...
#define CPSS_LION_ALL_DEVICES_CASES_MAC                   \
    ...
    case CPSS_LION_PORT_GROUPS_0__3_DEVICES_CASES_MAC /*caller end with ':' */
...
#define PRV_CPSS_DXCH_XCAT_DEVICES_WITH_STACK_HX_QX_CASES_MAC    \
    /*caller start with 'case' */                                \
         CPSS_98DX3124_CNS:/*this one exists in XG_HX_QX_CASES */\
    case CPSS_98DX3125_CNS:/*this one exists in XG_HX_QX_CASES */\
    case CPSS_98DX3224_CNS:/*this one exists in XG_HX_QX_CASES */\
...
#define PRV_CPSS_DXCH_XCAT_DEVICES_WITH_STACK_GIG_CASES_MAC      \
    ...
    case CPSS_98DXH125_CNS    /*caller end with ':' */
