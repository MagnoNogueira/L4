...
#include <cpss/generic/events/private/prvCpssGenMiiEmulateMsgQueue.h>
...
typedef struct
{
    ...
    GT_U32               headerOffset;
    void *               intQueId[PRV_CPSS_GEN_NETIF_MAX_RX_QUEUES_NUM_CNS];
    void *               auQueId;
    GT_U32               numOfRxBufs;
...
/*
 * Typedef: enumeration PRV_CPSS_GEN_NETIF_CPU_PORT_MODE_ENT
 *
 * Description: Defines the possible CPU network interface modes
 *
 * Enumerations:
 *    PRV_CPSS_GEN_NETIF_CPU_PORT_MODE_SDMA_E   - CPU Tx/Rx by SDMA
 *    PRV_CPSS_GEN_NETIF_CPU_PORT_MODE_MII_E    - CPU Tx/Rx by MII
 *    PRV_CPSS_GEN_NETIF_CPU_PORT_MODE_NONE_E   - This device isn't connected to CPU
 */
typedef enum
{
    PRV_CPSS_GEN_NETIF_CPU_PORT_MODE_SDMA_E,
    PRV_CPSS_GEN_NETIF_CPU_PORT_MODE_MII_E,
    PRV_CPSS_GEN_NETIF_CPU_PORT_MODE_NONE_E
} PRV_CPSS_GEN_NETIF_CPU_PORT_MODE_ENT;

/*******************************************************************************
* PRV_CPSS_GEN_NETIF_MII_PACKET_TX
*
* DESCRIPTION:
...
*                           descriptors.
*       packetBuffsArrPtr - The packet data buffers list.
*       buffLenArr        - A list of the buffers len in packetBuffs.
*       numOfBufs         - Length of packetBuffs.
*
* OUTPUTS:
*       None.
*
...
*
* COMMENTS:
*       transmit to the Eth port .
*
*******************************************************************************/
typedef GT_STATUS (*PRV_CPSS_GEN_NETIF_MII_PACKET_TX)
(
    IN GT_U8                devNum,
    IN CPSS_GEN_NETIF_MII_TX_PARAMS_STC *pcktParamsPtr,
    IN GT_U8               *packetBuffsArrPtr[],
    IN GT_U32               buffLenArr[],
    IN GT_U32               numOfBufs
);

typedef GT_STATUS (*PRV_CPSS_GEN_NETIF_MII_RX_INT_CAUSE_GET)
(
    IN GT_U8    devNum,
    IN  GT_U8   *mrvlTagPtr
);

typedef GT_STATUS (*PRV_CPSS_GEN_NETIF_MII_RX_GET)
(
    IN GT_U8                                devNum,
    IN GT_U8                                queueIdx,
...
typedef GT_STATUS (*PRV_CPSS_GEN_NETIF_MII_TX_DESC_SIZE_GET)
(
...
/*
 * Typedef: struct PRV_CPSS_GEN_NETIF_CPU_ETHER_PORT_INFO_STC
 *
 ...
 *      prvCpssNetIfMiiPacketTx - pointer to asic family dependent
*/
typedef struct{
    PRV_CPSS_GEN_NETIF_MII_PACKET_TX prvCpssNetIfMiiPacketTx;
    PRV_CPSS_GEN_NETIF_MII_RX_GET prvCpssDxChNetIfMiiRxGet;
}PRV_CPSS_GEN_NETIF_CPU_ETHER_PORT_INFO_STC;
...
#define PRV_CPSS_NETIF_MII_Q_PTR_SIZE_CNS           4
#define PRV_CPSS_NETIF_MII_TX_PTR_NUM_CNS           1
#define PRV_CPSS_NETIF_MII_TX_Q_MSG_LEN_CNS         (1 * PRV_CPSS_NETIF_MII_Q_PTR_SIZE_CNS)
#define PRV_CPSS_NETIF_MII_RX_Q_MSG_LEN_CNS         (2 * PRV_CPSS_NETIF_MII_Q_PTR_SIZE_CNS)
...
*/
#define PRV_CPSS_NETIF_MII_BYTES_MOVED_MASK_CNS    0xFF
#define PRV_CPSS_NETIF_MII_RX_ORIG_PCKT_TAG_BYTES_GET(bufPtr, headerOffset)   \
                (((*((bufPtr)-PRV_CPSS_NETIF_MII_RX_OFFSET_TO_INTERNAL_INFO_CNS(headerOffset))))  \
                                                & PRV_CPSS_NETIF_MII_BYTES_MOVED_MASK_CNS)

#define PRV_CPSS_NETIF_MII_RX_ORIG_PCKT_TAG_BYTES_SET(bufPtr,bytesMoved,headerOffset)  \
    {                                                                                     \
        (*((bufPtr)-PRV_CPSS_NETIF_MII_RX_OFFSET_TO_INTERNAL_INFO_CNS(headerOffset))) &= ~PRV_CPSS_NETIF_MII_BYTES_MOVED_MASK_CNS;  \
        (*((bufPtr)-PRV_CPSS_NETIF_MII_RX_OFFSET_TO_INTERNAL_INFO_CNS(headerOffset))) |= (bytesMoved & PRV_CPSS_NETIF_MII_BYTES_MOVED_MASK_CNS);\
    }
...
/*******************************************************************************
* prvCpssGenNetIfMiiTxPacketSend
*
* DESCRIPTION:
...
* RETURNS:
*       GT_OK          - on success, or
*       GT_NO_RESOURCE - if there is not enough descriptors
*       GT_FAIL otherwise.
*
* COMMENTS:
...
*
*******************************************************************************/
GT_STATUS prvCpssGenNetIfMiiTxPacketSend
(
    IN GT_U8                            devNum,
    IN CPSS_GEN_NETIF_MII_TX_PARAMS_STC *pcktParamsPtr,
    IN GT_U8                            *packetBuffsArrPtr[],
...
/*******************************************************************************
* prvCpssGenNetIfMiiTxPacketSendSync
*
* DESCRIPTION:
*       This function receives packet buffers & parameters from Application .
...
*                               descriptors.
*       packetBuffsArrPtr   - The packet data buffers list.
*       buffLenArr          - A list of the buffers len in buffList.
...
*
*******************************************************************************/
GT_STATUS prvCpssGenNetIfMiiTxPacketSendSync
(
    IN GT_U8    devNum,
    IN CPSS_GEN_NETIF_MII_TX_PARAMS_STC *pcktParamsPtr,
    IN GT_U8    *packetBuffsArrPtr[],
...
*
*
* APPLICABLE DEVICES: All devices with MII interface
*
* INPUTS:
*       devNum      - Device number.
