...
*
*******************************************************************************/
#ifndef __cpssDxChIpLpmUch
#define __cpssDxChIpLpmUch
...
*
*******************************************************************************/
GT_STATUS cpssDxChIpTcamAddIpUcEntry
(
    IN GT_U32                                 vrId,
    IN GT_U8                                  *ipDestPtr,
    IN GT_U32                                 ipPrefix,
...
*
*******************************************************************************/
GT_STATUS cpssDxChIpTcamDeleteIpUcEntry
(
    IN GT_U32                             vrId,
    IN GT_U8                              *ipDestPtr,
    IN GT_U32                             ipPrefix,
...
/*******************************************************************************
* cpssDxChIpTcamFlushIpUcEntries
*
* DESCRIPTION:
...
*       protocolStack - types of IP we're dealing with.
*       ipTcamShadowPtr - the ip shadow we are working on.
*       flushDefault - weather to flush the defualt
*
* OUTPUTS:
*       None.
*
...
*
*******************************************************************************/
GT_STATUS cpssDxChIpTcamFlushIpUcEntries
(
    IN GT_U32                             vrId,
    IN CPSS_IP_PROTOCOL_STACK_ENT         protocolStack,
    IN PRV_CPSS_DXCH_IP_TCAM_SHADOW_STC   *ipTcamShadowPtr,
...
*
*******************************************************************************/
GT_STATUS cpssDxChIpTcamSearchIpUcEntry
(
    IN  GT_U32                                      vrId,
    IN  GT_U8                                       *ipAddrPtr,
    IN  GT_U32                                      prefix,
...
/*******************************************************************************
* cpssDxChIpTcamUcRuleOffsetGet
*
* DESCRIPTION:
*       This function searches for a given ip-uc address, and returns the
*       Ip Tcam unicast rule offset associated with it.
*
* APPLICABLE DEVICES:  All DxCh devices
*
* INPUTS:
...
*
* OUTPUTS:
*       ipTcamRuleOffsetPtr - pointer to TCAM rule offset
*
* RETURNS:
...
GT_STATUS cpssDxChIpTcamUcRuleOffsetGet
(
    IN  GT_U32                                      vrId,
    IN  GT_U8                                       *ipAddrPtr,
    ...
    IN  CPSS_IP_PROTOCOL_STACK_ENT                  protocolStack,
    IN  PRV_CPSS_DXCH_IP_TCAM_SHADOW_STC            *ipTcamShadowPtr,
    OUT GT_U32                                      *ipTcamRuleOffsetPtr
);

/*******************************************************************************
* cpssDxChIpTcamGetIpUcEntry
*
* DESCRIPTION:
...
*
*******************************************************************************/
GT_STATUS cpssDxChIpTcamGetIpUcEntry
(
    IN GT_U32                                   vrId,
