 ...
 *                  NOTE: the size is (CPSS_MAX_PORT_GROUPS_CNS - 1)
 *
 ...
 *                  NOTE: used when numOfUplinkPorts > 1 the size is CPSS_MAX_PORT_GROUPS_CNS
 *
 ...
 *
 *  lastPortGroupId - the portGroupId that represent the 'last' port-group-id ,
 *              the port-group that 'ends' the interconnection loop.
...
typedef struct
{
    ...
    GT_U8       *unknownUnregDesignatedDeviceArray;/*[CPSS_MAX_PORT_GROUPS_CNS - 1]*/
