 ...
 *
 * Enumerations:
 *    CPSS_DP_GREEN  - conforming
 *    CPSS_DP_YELLOW - last conforming
 *    CPSS_DP_RED    - non conforming
 */
typedef enum
{
    CPSS_DP_GREEN_E = 0,
 ...
 *      enableModifyDscp - mac modification mode of the dscp filed
 * COMMENTS:
 ***********************************************************************/
typedef struct
{
 ...
 *
 * Enumerations:
 *      CPSS_QOS_PORT_NO_TRUST - untrust: packet QosProfile is assigned as the
 *                             port's default PortQosProfile.
 *      CPSS_QOS_PORT_TRUST_L2 - if the packet is tagged the Qos Profile is
 ...
 *      CPSS_QOS_PORT_TRUST_L3 - if the packet is IPv4/IPv6 the QoS profile is
 *          assigned to the Dscp field or remapped Dscp, else according to
 *          Port's Default QoS Profile.
 *      CPSS_QOS_PORT_TRUST_L2_L3 - if the packet is IPv4/IPv6 the packet is
...
/**********************************************************************
 * typedef: enum GT_MAC_QOS_RESOLVE_TYPE
 *
 * Description:
 *      MAC QoS Marking Conflict Resolution mode.
 *
 * Enumerations:
 *      GT_MAC_QOS_GET_FROM_DA - get the QoS attribute index from DA.
 *      GT_MAC_QOS_GET_FROM_SA - get the QoS attribute index from SA
 *********************************************************************/
typedef enum
{
