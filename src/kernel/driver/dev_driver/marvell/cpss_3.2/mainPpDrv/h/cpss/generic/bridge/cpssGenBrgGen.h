 ...
 *
 * Enumerations:
 *   CPSS_IGMP_TRAP_MODE            - All IGMP packets are trapped to CPU.
 *   CPSS_IGMP_SNOOP_TRAP_MODE      - Query messages are mirrored, non-query are 
 *                                    trapped.
 *   CPSS_IGMP_ROUTER_MIRROR_MODE   - All IGMP packets are mirrored to CPU.
 *   CPSS_IGMP_FWD_DECISION_MODE    - All IGMP packets forwarding decision 
