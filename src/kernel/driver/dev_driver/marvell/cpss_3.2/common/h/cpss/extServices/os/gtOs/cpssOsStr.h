...
*
*******************************************************************************/
typedef GT_8 * (*CPSS_OS_STR_CPY_FUNC)
(
    IN GT_8         *dest,
    IN const GT_8   *source
);
...
*
*******************************************************************************/
typedef GT_8 * (*CPSS_OS_STR_N_CPY_FUNC)
(
    IN GT_8         *dest,
    IN const GT_8   *source,
    IN GT_U32       len
...
*
*******************************************************************************/
typedef GT_8 * (*CPSS_OS_STR_CHR_FUNC)
(
    IN const GT_8   *source,
    IN GT_32        character
);
...
*
*******************************************************************************/
typedef GT_8 * (*CPSS_OS_STR_CAT_FUNC)
(
    IN GT_8         *str1,
    IN const GT_8   *str2
);
...
*
*******************************************************************************/
typedef GT_8 * (*CPSS_OS_STR_N_CAT_FUNC)
(
    IN GT_8         *str1,
    IN const GT_8   *str2,
    IN GT_U32       len
