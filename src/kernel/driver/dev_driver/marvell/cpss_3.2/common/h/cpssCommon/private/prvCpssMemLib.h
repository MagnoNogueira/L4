...
typedef struct memData
{
    ...
    GT_U32  ptr;            /* pointer to the memory area (second search key)*/
...
*
*******************************************************************************/
GT_U32 prvCpssMemDevPoolCreate(void);
...
*
*******************************************************************************/
GT_U32 prvCpssMemDevPoolMallocLowest
(
    IN GT_U32 poolId,
    IN GT_U32 size,
    IN GT_U32 bitAllign
...
*
*******************************************************************************/
GT_U32 prvCpssMemDevPoolMallocHighest
(
    IN GT_U32 poolId,
    IN GT_U32 size,
    IN GT_U32 bitAllign
...
*
*******************************************************************************/
GT_U32 prvCpssMemDevPoolMalloc
(
    IN GT_U32 poolId,
    IN GT_U32 size,
    IN GT_U32 bitAllign
