...
#define DMM_GET_PARTITION(handler)  ((GT_U32)(((GT_DMM_BLOCK*)handler)->nextBySizeOrPartitionPtr.partitionPtr))
...
*
*******************************************************************************/
GT_U32 prvCpssDmmAllocate
(
    IN GT_U32       partitionId,
    IN GT_U32       size,
    IN GT_U32       alignment
);
...
*
*******************************************************************************/
GT_U32 prvCpssDmmStaticAllocate
(
    IN GT_U32       partitionId,
    IN GT_U32       size,
    IN GT_U32       alignment
...
*
*******************************************************************************/
GT_U32 prvCpssDmmAllocateByPtr
(
    IN GT_U32       partitionId,
    IN GT_U32       hwOffset,
    IN GT_U32       size,
