...
#define PR_1                            BCM_FIELD_ENTRY_PRIO_1
#define PR_2                            BCM_FIELD_ENTRY_PRIO_2
#define PR_3                            BCM_FIELD_ENTRY_PRIO_3
#define PR_4                            BCM_FIELD_ENTRY_PRIO_4
#define PR_5                            BCM_FIELD_ENTRY_PRIO_5
#define PR_6                            BCM_FIELD_ENTRY_PRIO_6
#define PR_7                            BCM_FIELD_ENTRY_PRIO_7
#define PR_8                            BCM_FIELD_ENTRY_PRIO_8
...
#if (SYS_CPNT_ACL_IPV6 == TRUE) || (SYS_CPNT_IPV6 == TRUE)
static FP_CONFIG_FieldQualifyDescriptor_T fp_config_fq_ingress_ipv6_ext_acl_diffserv_link_local[] = {
...
#endif /* SYS_CPNT_ACL_IPV6 || SYS_CPNT_IPV6 */
...
static FP_CONFIG_FieldQualifyDescriptor_T fp_config_fq_web_auth_ip_src_guard[] = {
...
#if (SYS_CPNT_ACL_IPV6 == TRUE) || (SYS_CPNT_IPV6 == TRUE)
static FP_CONFIG_FunctionDescriptor_T fp_config_fd_ip6_ext_acl_link_local[] =
{
#if (SYS_CPNT_ACL_IPV6 == TRUE)
...
{
#if (SYS_CPNT_ACL_IPV6 == TRUE)
    FP_CONFIG_FUNC_DESC(RT_IP_ACL, PR_3, SYS_ADPT_MAX_NBRS_OF_IP_ACE),
#endif
...
{
#if (SYS_CPNT_ACL_IPV6 == TRUE)
    FP_CONFIG_FUNC_DESC(RT_MAC_ACL, PR_3, SYS_ADPT_MAX_NBRS_OF_MAC_ACE),
#endif
    FP_CONFIG_FUNC_DESC(RT_MAC_QOS, PR_DEFAULT, SYS_ADPT_DIFFSERV_MAX_NBR_OF_MAC_RULE)
};

static FP_CONFIG_FunctionDescriptor_T fp_config_fd_web_auth_ip_src_guard[] =
{
#if (SYS_CPNT_WEBAUTH == TRUE)
...
static FP_CONFIG_STRUCT_T fp_config_struct[] =
{
    ...
    (
        ...
        FP_CONFIG_VECTOR(fp_config_fq_ingress_ipv6_ext_acl_diffserv_link_local),    /* fq_vector */
        FP_CONFIG_NULL_VECTOR(),                                        /* udf_vector */
        FP_CONFIG_VECTOR(fp_config_fd_ip6_ext_acl_link_local)           /* func_vector */
    ),
#else /* SYS_CPNT_ACL_IPV6 */
    FP_CONFIG_STRUCT
    (
        1,                                                              /* group_id */
        SINGLE,                                                         /* group_mode */
    ...
    (
        ...
        FP_CONFIG_VECTOR(fp_config_fq_web_auth_ip_src_guard),           /* fq_vector */
        FP_CONFIG_NULL_VECTOR(),                                        /* udf_vector */
        FP_CONFIG_VECTOR(fp_config_fd_web_auth_ip_src_guard)            /* func_vector */
    ),
...
/*------------------------------------------------------------------------------
 * FUNCTION NAME: FP_CONFIG_CountBits
 *------------------------------------------------------------------------------
 * PURPOSE: Count bits
 * INPUT:   bitmap - 32 bit bitmap
 * OUTPUT:  None
 * RETUEN:  How many bits be set
 * NOTES:
 *------------------------------------------------------------------------------
 */
