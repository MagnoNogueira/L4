...
static FP_CONFIG_FieldQualifyDescriptor_T fp_config_fq_pbr[] = {
    FP_CONFIG_FQ(InPort),
    FP_CONFIG_FQ(EtherType),
    FP_CONFIG_FQ(OuterVlan),
...
static FP_CONFIG_FunctionDescriptor_T fp_config_fd_pbr[] =
{
    FP_CONFIG_FUNC_DESC(RT_PBF, PR_HIGHEST, 0)
};
...
static FP_CONFIG_STRUCT_T fp_config_struct[] =
{
    ...
    (
        ...
        FP_CONFIG_VECTOR(fp_config_fq_pbr),                             /* fq_vector */
        FP_CONFIG_NULL_VECTOR(),                                        /* udf_vector */
        FP_CONFIG_VECTOR(fp_config_fd_pbr)                              /* func_vector */
    ),
