...
#define RT_IPV6_SG_PERMIT_LINK_LOCAL    RULE_TYPE_IPV6_SG_PERMIT_LINK_LOCAL
...
#define FP_CONFIG_MAX(a, b) ((a > b) ? a : b)
#define FP_CONFIG_MIN(a, b) ((a < b) ? a : b)
...
static FP_CONFIG_TemplateKeyDescriptor_T fp_config_tk_egress_ipv6_acl[] = {
    FP_CONFIG_TK(FP_CONFIG_TEMPLATE_3),
    FP_CONFIG_TK(FP_CONFIG_TEMPLATE_7),
};

static FP_CONFIG_TemplateKeyDescriptor_T fp_config_tk_egress_ip_acl[] = {
    FP_CONFIG_TK(FP_CONFIG_TEMPLATE_6),
};

static FP_CONFIG_TemplateKeyDescriptor_T fp_config_tk_egress_mac_acl[] = {
    FP_CONFIG_TK(FP_CONFIG_TEMPLATE_5),
};

static FP_CONFIG_TemplateKeyDescriptor_T fp_config_tk_egress_ipv6_diffserv[] = {
    FP_CONFIG_TK(FP_CONFIG_TEMPLATE_3),
    FP_CONFIG_TK(FP_CONFIG_TEMPLATE_7),
};

static FP_CONFIG_TemplateKeyDescriptor_T fp_config_tk_egress_ip_diffserv[] = {
    FP_CONFIG_TK(FP_CONFIG_TEMPLATE_6),
};

static FP_CONFIG_TemplateKeyDescriptor_T fp_config_tk_egress_mac_diffserv[] = {
    FP_CONFIG_TK(FP_CONFIG_TEMPLATE_5),
};
...
static FP_CONFIG_FunctionDescriptor_T fp_config_fd_ip6_source_guard[] =
{
    ...
    FP_CONFIG_FUNC_DESC(RT_IPV6_SG_PERMIT_HOST, PR_HIGHEST, 0),
    FP_CONFIG_FUNC_DESC(RT_IPV6_SG_PERMIT_LINK_LOCAL, PR_DEFAULT, 0),
    FP_CONFIG_FUNC_DESC(RT_IPV6_SG_DENY_ALL, PR_LOWEST, 0),
#endif /* IP_SOURCE_GUARD */
};
...
static FP_CONFIG_FunctionDescriptor_T fp_config_fd_vlan[] =
{
    ...
    FP_CONFIG_FUNC_DESC(RT_VOICE_VLAN, PR_2, SYS_ADPT_MAX_NBR_OF_PHONE_OUI_PER_PORT * (MAX_voiceVlanPortPriority+1)),
#endif /* SYS_CPNT_ADD_MODIFY_PRIORITY_BY_RULE */

#if (SYS_CPNT_MAC_VLAN == TRUE) && (SYS_CPNT_MAC_VLAN_IMPLEMENTED_BY_RULE == TRUE)
    FP_CONFIG_FUNC_DESC(RT_MAC_VLAN, PR_3, SYS_ADPT_MAX_NBR_OF_MAC_VLAN_ENTRY),
#endif /* SYS_CPNT_MAC_VLAN && SYS_CPNT_MAC_VLAN_IMPLEMENTED_BY_RULE */

#if (SYS_CPNT_IP_SUBNET_VLAN == TRUE) && (SYS_CPNT_IP_SUBNET_VLAN_IMPLEMENTED_BY_RULE  == TRUE)
#if (SYS_CPNT_IP_SUBNET_VLAN_BIND_PORT == FALSE)
    FP_CONFIG_FUNC_DESC(RT_IP_SUBNET_VLAN, PR_4, SYS_ADPT_MAX_NBR_OF_IP_SUBNET_VLAN_ENTRY),
...
#define FP_CONFIG_MAX_RULE_NUM_OF_PROTOCOL_VLAN \
            FP_CONFIG_MIN(SYS_ADPT_MAX_NBR_OF_SWITCH_PORT_PER_CHIP * SYS_ADPT_1V_MAX_NBR_OF_PROTOCOL_GROUP_ENTRY, \
                          SYS_ADPT_FP_MAX_NBR_OF_RULE_PER_SELECTOR)

    FP_CONFIG_FUNC_DESC(RT_PROTOCOL_VLAN, PR_5, FP_CONFIG_MAX_RULE_NUM_OF_PROTOCOL_VLAN),
#endif /* SYS_CPNT_PROTOCOL_VLAN && SYS_CPNT_PROTOCOL_VLAN_IMPLEMENTED_BY_RULE */

};

#if (SYS_CPNT_QOS_V2_EGRESS_PORT == TRUE)
static FP_CONFIG_FunctionDescriptor_T fp_config_fd_egress_ip6_acl[] =
{
    FP_CONFIG_FUNC_DESC(RT_EGRESS_IP6_STD_ACL, PR_3, SYS_ADPT_MAX_NBRS_OF_IPV6_ACE),
    FP_CONFIG_FUNC_DESC(RT_EGRESS_IP6_EXT_ACL, PR_3, SYS_ADPT_MAX_NBRS_OF_IPV6_ACE),
};

static FP_CONFIG_FunctionDescriptor_T fp_config_fd_egress_ip_acl[] =
{
    FP_CONFIG_FUNC_DESC(RT_EGRESS_IP_ACL, PR_DEFAULT, SYS_ADPT_MAX_NBRS_OF_IP_ACE),
};

static FP_CONFIG_FunctionDescriptor_T fp_config_fd_egress_mac_acl[] =
{
    FP_CONFIG_FUNC_DESC(RT_EGRESS_MAC_ACL, PR_DEFAULT, SYS_ADPT_MAX_NBRS_OF_MAC_ACE),
};

static FP_CONFIG_FunctionDescriptor_T fp_config_fd_egress_ip6_diffserv[] =
{
    FP_CONFIG_FUNC_DESC(RT_EGRESS_IP6_STD_QOS, PR_DEFAULT, SYS_ADPT_DIFFSERV_MAX_NBR_OF_IPV6_RULE),
    FP_CONFIG_FUNC_DESC(RT_EGRESS_IP6_EXT_QOS, PR_DEFAULT, SYS_ADPT_DIFFSERV_MAX_NBR_OF_IPV6_RULE),
};

static FP_CONFIG_FunctionDescriptor_T fp_config_fd_egress_ip_diffserv[] =
{
    FP_CONFIG_FUNC_DESC(RT_EGRESS_IP_QOS, PR_DEFAULT, SYS_ADPT_DIFFSERV_MAX_NBR_OF_IP_RULE),
};

static FP_CONFIG_FunctionDescriptor_T fp_config_fd_egress_mac_diffserv[] =
{
    FP_CONFIG_FUNC_DESC(RT_EGRESS_MAC_QOS, PR_DEFAULT, SYS_ADPT_DIFFSERV_MAX_NBR_OF_MAC_RULE),
};
#endif /* SYS_CPNT_QOS_V2_EGRESS_PORT */
...
static FP_CONFIG_STRUCT_T fp_config_struct[] =
{
    ...
    (
     ...
     EFP,                                                            /* selector_stage */
     SELECTOR_0,                                                     /* first_selector_num */
     FP_CONFIG_VECTOR(fp_config_tk_egress_ipv6_acl),                 /* tk_vector */
     FP_CONFIG_NULL_VECTOR(),                                        /* udf_vector */
     FP_CONFIG_VECTOR(fp_config_fd_egress_ip6_acl)                   /* func_vector */
    ),
    ...
    (
     ...
     EFP,                                                            /* selector_stage */
     SELECTOR_1,                                                     /* first_selector_num */
     FP_CONFIG_VECTOR(fp_config_tk_egress_ip_acl),                   /* tk_vector */
     FP_CONFIG_NULL_VECTOR(),                                        /* udf_vector */
     FP_CONFIG_VECTOR(fp_config_fd_egress_ip_acl)                    /* func_vector */
    ),
    ...
    (
     ...
     EFP,                                                            /* selector_stage */
     SELECTOR_2,                                                     /* first_selector_num */
     FP_CONFIG_VECTOR(fp_config_tk_egress_mac_acl),                  /* tk_vector */
     FP_CONFIG_NULL_VECTOR(),                                        /* udf_vector */
     FP_CONFIG_VECTOR(fp_config_fd_egress_mac_acl)                   /* func_vector */
    ),
    ...
    (
     ...
     EFP,                                                            /* selector_stage */
     SELECTOR_3,                                                     /* first_selector_num */
     FP_CONFIG_VECTOR(fp_config_tk_egress_ipv6_diffserv),            /* tk_vector */
     FP_CONFIG_NULL_VECTOR(),                                        /* udf_vector */
     FP_CONFIG_VECTOR(fp_config_fd_egress_ip6_diffserv)              /* func_vector */
    ),
    ...
    (
     ...
     EFP,                                                            /* selector_stage */
     SELECTOR_4,                                                     /* first_selector_num */
     FP_CONFIG_VECTOR(fp_config_tk_egress_ip_diffserv),              /* tk_vector */
     FP_CONFIG_NULL_VECTOR(),                                        /* udf_vector */
     FP_CONFIG_VECTOR(fp_config_fd_egress_ip_diffserv)               /* func_vector */
    ),
    ...
    (
     ...
     EFP,                                                            /* selector_stage */
     SELECTOR_5,                                                     /* first_selector_num */
     FP_CONFIG_VECTOR(fp_config_tk_egress_mac_diffserv),             /* tk_vector */
     FP_CONFIG_NULL_VECTOR(),                                        /* udf_vector */
     FP_CONFIG_VECTOR(fp_config_fd_egress_mac_diffserv)              /* func_vector */
    ),
#endif /* SYS_CPNT_QOS_V2_EGRESS_PORT */
};
