...
static BOOL_T RULE_CTRL_Create_Meter(UI32_T unit, UI32_T port, UI32_T device_id,UI32_T dev_rule_id, DEVRM_POLICER_METER_T *meter_entry_p);
static BOOL_T RULE_CTRL_Local_Create_Meter(UI32_T device_id,UI32_T dev_rule_id, DEVRM_POLICER_METER_T *meter_entry_p);

static BOOL_T RULE_CTRL_Update_Meter(UI32_T unit, UI32_T port, UI32_T device_id,UI32_T dev_rule_id, DEVRM_POLICER_METER_T *meter_entry_p);
static BOOL_T RULE_CTRL_Local_Update_Meter(UI32_T device_id,UI32_T dev_rule_id, DEVRM_POLICER_METER_T *meter_entry_p);
...
static BOOL_T RULE_CTRL_Set_Action(UI32_T unit, UI32_T port, UI32_T device_id, UI32_T rule_id, DEVRM_ACTION_T *action_p);
static BOOL_T RULE_CTRL_Local_Set_Action(UI32_T device_id, UI32_T rule_id, DEVRM_ACTION_T *action_p);
